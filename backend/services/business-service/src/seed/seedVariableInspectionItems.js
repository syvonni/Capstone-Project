...
const VARIABLE_INSPECTION_ITEMS = [
  // Salon/Barber Chair Fee
  {
    ...
    question: 'Does the business have the correct number of barber chairs or salon stations as declared?',
    notes: 'Verify the actual count of barber chairs or salon stations against the declared number. Check all service areas.',
  ...
  },
  {
    ...
    question: 'Does the business maintain proper documentation of chair/station count?',
    notes: 'Check for business permit application forms, floor plans, or other documentation showing chair/station count.',
  ...
  // Parking Space Fee
  {
    ...
    question: 'Does the business have the correct parking area in square meters as declared?',
    notes: 'Verify the actual parking area measurement against the declared area. Use measuring tools if necessary.',
  ...
  },
  {
    ...
    notes: 'Check if parking spaces are accessible, properly marked, and comply with accessibility standards.',
  ...
  // Storage Area Fee
  {
    ...
    question: 'Does the business have the correct warehouse/storage area in square meters as declared?',
    notes: 'Verify the actual storage area measurement against the declared area. Check all storage facilities.',
  ...
  },
  {
    ...
    notes: 'Check for fire safety, structural integrity, and proper ventilation in storage areas.',
  ...
  // Boarding Capacity Fee
  {
    ...
    question: 'Does the boarding house/dormitory have the correct boarder capacity as declared?',
    notes: 'Verify the actual number of boarders against the declared capacity. Check room assignments.',
  ...
  },
  {
    ...
    question: 'Does the boarding house/dormitory comply with safety and occupancy standards?',
    notes: 'Check for fire safety, emergency exits, and compliance with occupancy limits per room.',
  ...
  // PUV Unit Fee
  {
    ...
    notes: 'Verify the actual count of PUVs (bus, jeepney, taxi) against the declared number. Check registration documents.',
  ...
  },
  {
    ...
    notes: 'Check LTFRB franchise documents and registration validity for each vehicle.',
  ...
  // Trucking Unit Fee
  {
    ...
    question: 'Does the business have the correct number of trucking vehicles as declared?',
    notes: 'Verify the actual count of trucking/hauling vehicles against the declared number. Check registration documents.',
  ...
  },
  {
    ...
    question: 'Are all trucking vehicles properly registered with valid permits?',
  ...
  // Mining Hectare Fee
  {
    ...
    question: 'Does the mining operation have the correct mining area in hectares as declared?',
    notes: 'Verify the actual mining area against the declared area. Check survey documents and permits.',
  ...
  // Subdivision Lot Fee
  {
    ...
    question: 'Does the subdivision have the correct number of saleable lots as declared?',
    notes: 'Verify the actual number of saleable lots against the declared count. Check subdivision plans.',
  ...
  // Subdivision Area Fee
  {
    ...
    question: 'Does the subdivision have the correct total area in hectares as declared?',
    notes: 'Verify the actual subdivision area against the declared area. Check survey documents.',
  ...
  // Subdivision Floor Area Fee
  {
    ...
    question: 'Does the subdivision have the correct housing component floor area as declared?',
    notes: 'Verify the actual housing component floor area against the declared area. Check building plans.',
  ...
  // Hospital Bed Fee
  {
    ...
    notes: 'Verify the actual bed capacity against the declared count. Check all wards and rooms.',
  ...
  // Printing Machine Fee
  {
    ...
    question: 'Does the business have the correct number of printing machines as declared?',
    notes: 'Verify the actual count of printing machines against the declared number. Check all equipment.',
  ...
  },
  {
    ...
    notes: 'Check for any required registrations or permits for printing equipment.',
  ...
  // Market Stall Fee
  {
    ...
    question: 'Does the market stall have the correct floor area in square meters as declared?',
    notes: 'Verify the actual stall floor area against the declared area. Use measuring tools if necessary.',
  ...
  },
  {
    ...
    notes: 'Check market stall assignment documents and ensure they are current.',
  ...
  // Hotel Room Fee
  {
    ...
    notes: 'Verify the actual room count against the declared number. Check all room types.',
  ...
  // Apartment Unit Fee
  {
    ...
    question: 'Does the apartment business have the correct number of rental units as declared?',
    notes: 'Verify the actual number of rental units against the declared count. Check all units.',
  ...
  // Bank Classification Fee
  {
    ...
    notes: 'Verify the bank type (Rural/Thrift, Commercial/Industrial, Universal) against BSP records.',
  ...
  // Lending Classification Fee
  {
    ...
    notes: 'Verify the lending institution type (Lending Investor, Money Shop, Investment Company) against SEC records.',
  ...
  // Parking Available (Yes/No)
  {
    ...
    notes: 'Verify the presence of parking space. Check if it meets local requirements.',
...
async function seedVariableInspectionItems() {
  ...
  for (const itemData of VARIABLE_INSPECTION_ITEMS) {
    ...
    if (!violationId) {
      console.warn(`  ! Warning: Violation not found: ${violationCode} - skipping inspection item: ${itemData.name}`);
      continue;
    }
    ...
    if (!existing) {
      ...
      totalCreated++;
      console.log(`  + Created: ${itemData.name} (linked to violation: ${violationCode})`);
    } else {
      ...
      totalUpdated++;
      console.log(`  ~ Updated: ${itemData.name} (linked to violation: ${violationCode})`);
    }
  }
