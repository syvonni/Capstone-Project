...
import { useVariableForm } from '../useVariableForm.jsx';
...
describe('useVariableForm', () => {
  ...
  it('should return correct structure', () => {
    ...
    expect(result.current).toHaveProperty('handleSummaryClose');
    ...
    expect(result.current).toHaveProperty('changesSummaryModal');
  });
});
