...
const variableFeeRuleRouter = createAuditRouter('variable_fee_rule', variableFeeRuleConfig, {
...
const postRequirementRouter = createAuditRouter('post_requirement', postRequirementConfig, {
