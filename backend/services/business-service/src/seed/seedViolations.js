...
const VIOLATIONS = [
  {
    ...
    description: 'Boxes, cartons, or storage items within 1 meter of fire exit doors',
    ...
    legalBasis: [
      {
        ...
        description: 'Section 7.2.1: Means of egress must be maintained free and unobstructed'
      },
      {
        ...
        description: 'Section 10: Exit routes must be kept clear and unobstructed at all times'
      }
    ],
  ...
  },
  {
    ...
    description: 'Furniture, chairs, tables, or equipment within 1 meter of fire exit doors',
  ...
  },
  {
    ...
    description: 'Equipment, machinery, or appliances within 1 meter of fire exit doors',
  ...
  },
  {
    ...
    description: 'No fire extinguisher present and accessible in the kitchen area',
    ...
    legalBasis: [
      {
        ...
        description: 'Section 6.1.1: Fire extinguishers must be provided where required by applicable codes'
      },
      {
        url: 'https://www.officialgazette.gov.ph/2019/08/12/republic-act-no-11259/',
        title: 'Republic Act No. 11259 - Fire Code of the Philippines',
        description: 'Section 11: Fire extinguishers must be provided in all commercial establishments'
      }
    ],
  ...
  },
  {
    ...
    description: 'No fire extinguisher present and accessible in the storage area',
    ...
    legalBasis: [
      {
        url: 'https://www.nfpa.org/codes-and-standards/all-codes-and-standards/list-of-codes-and-standards/detail?code=10',
        title: 'NFPA 10 - Standard for Portable Fire Extinguishers',
        description: 'Section 6.1.3.1: Fire extinguishers must be located along normal paths of travel and near exits'
      },
      {
        url: 'https://www.officialgazette.gov.ph/2019/08/12/republic-act-no-11259/',
        title: 'Republic Act No. 11259 - Fire Code of the Philippines',
    ...
    legalBasis: [
      {
        url: 'https://www.nfpa.org/codes-and-standards/all-codes-and-standards/list-of-codes-and-standards/detail?code=10',
        title: 'NFPA 10 - Standard for Portable Fire Extinguishers',
        description: 'Section 7.3.1: Fire extinguishers must be inspected annually by certified fire protection professional'
      },
      {
        url: 'https://www.officialgazette.gov.ph/2019/08/12/republic-act-no-11259/',
        title: 'Republic Act No. 11259 - Fire Code of the Philippines',
        description: 'Section 12: Fire extinguishers must undergo annual inspection and maintenance'
      }
    ],
    ...
    legalBasis: [
      {
        url: 'https://www.nfpa.org/codes-and-standards/all-codes-and-standards/list-of-codes-and-standards/detail?code=10',
        title: 'NFPA 10 - Standard for Portable Fire Extinguishers',
        description: 'Section 7.2.1: Fire extinguishers must be maintained in fully charged and operable condition'
      },
      {
        url: 'https://www.officialgazette.gov.ph/2019/08/12/republic-act-no-11259/',
        title: 'Republic Act No. 11259 - Fire Code of the Philippines',
        description: 'Section 12: Fire extinguishers must be maintained in fully charged and operable condition'
      }
    ],
  ...
  },
  {
    ...
    description: 'Waste not properly segregated into biodegradable, non-biodegradable, and recyclable',
    ...
    legalBasis: [
      {
        ...
        description: 'Section 21: Mandatory segregation of solid waste at source'
      }
    ],
    ...
    legalBasis: [
      {
        url: 'https://www.officialgazette.gov.ph/2000/01/26/republic-act-no-9003/',
        title: 'Republic Act No. 9003 - Ecological Solid Waste Management Act',
        description: 'Section 21: Establishments must provide appropriate waste containers'
      }
    ],
    ...
    legalBasis: [
      {
        ...
        description: 'Section 13: All establishments handling food must display valid sanitary permits'
      }
    ],
    ...
    legalBasis: [
      {
        url: 'https://www.nfpa.org/codes-and-standards/all-codes-and-standards/list-of-codes-and-standards/detail?code=101',
        title: 'NFPA 101 - Life Safety Code',
        description: 'Section 8.2: Buildings must be maintained in safe condition'
      },
      {
        ...
        description: 'Section 301: Buildings must be maintained in safe condition'
      }
    ],
  ...
  },
  {
    ...
    description: 'Structural modifications made without proper building permits',
    ...
    legalBasis: [
      {
        url: 'https://www.officialgazette.gov.ph/1977/08/24/presidential-decree-no-1185/',
        title: 'Presidential Decree No. 1185 - National Building Code',
        description: 'Section 301: All structural modifications require building permits'
      }
    ],
    ...
    legalBasis: [
      {
        ...
        description: 'Section 12: All business establishments must display valid business permits'
      }
    ],
...
async function forceReseed() {
  try {
    ...
    console.log(`Reseeded ${createdViolations.length} violations and created ${createdFees.length} penalty fees`);
