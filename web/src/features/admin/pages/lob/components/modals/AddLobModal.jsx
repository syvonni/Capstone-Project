...
const CATEGORY_OPTIONS = LINE_OF_BUSINESS.map(category => ({
    ...
    <>
      ...
      >
        ...
        <Form form={form} layout="vertical" style={{ marginTop: 16 }} requiredMark={false}>
            ...
            <Form.Item
              name="category"
              label={<span>Category<span style={{ color: token.colorError, marginLeft: 4 }}>*</span></span>}
            ...
            <Form.Item
              name="lineOfBusiness"
              label={<span>Line of Business<span style={{ color: token.colorError, marginLeft: 4 }}>*</span></span>}
              ...
              {(fields, { add, remove }) => (
                <>
                  ...
                  {fields.map(({ key, name, ...restField }) => (
                    <div key={key} style={{ marginBottom: 16, padding: 16, border: `1px solid ${token.colorBorderSecondary}`, borderRadius: 8, marginTop: 8 }}>
                      <Form.Item
                        {...restField}
                        name={[name, 'name']}
                        label="Bracket Name"
                      ...
                      >
                        <InputNumber style={{ width: '100%' }} min={0} placeholder="Leave empty for no maximum" />
                      </Form.Item>
                      <Form.Item
                        {...restField}
                      ...
                      <Form.Item
                        {...restField}
                        name={[name, 'excessRate']}
                        label="Excess Rate (%)"
                      >
                        <InputNumber style={{ width: '100%' }} min={0} max={100} step={0.01} placeholder="0" />
                      </Form.Item>
