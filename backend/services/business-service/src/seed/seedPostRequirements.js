...
} = require("./seedPostRequirementViolations");
const {
  seedPostRequirementInspectionItems,
} = require("./seedPostRequirementInspectionItems");
const {
  seedPostRequirementChecklists,
} = require("./seedPostRequirementChecklists");
...
const POST_REQUIREMENTS = [
  // AMLC Registration
  {
    ...
    question:
      "Is your business a covered person under the Anti-Money Laundering Act?",
    description:
      "Registration with Anti-Money Laundering Council for covered persons",
    notes:
      "Registration with Anti-Money Laundering Council for covered persons per RA 9160",
    legalBasis: [
      {
  ...
  },
  {
    ...
    notes:
      "Certificate of attendance from Animal Welfare Seminar conducted by BAI/DA-RFOs or BAI-recognized organization",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1998/02/11/republic-act-no-8485/",
        title: "RA 8485 - Animal Welfare Act of 1998",
        description:
          "Requires Animal Welfare Seminar certificate for animal handlers",
      },
    ],
    customFields: [
      {
  ...
  },
  {
    ...
    question: null,
    description:
      "Authorization from DENR/Mines and Geosciences Bureau for hauling mineral products",
    ...
    legalBasis: [
      {
        ...
        description:
          "Requires authorization for hauling and transporting mineral products",
      },
    ],
    customFields: [
      {
  ...
  // Animal Health Regulation (BAI)
  {
    ...
    question:
      "Is your business a veterinary clinic, hospital, or animal facility?",
    description:
      "Registration with Bureau of Animal Industry for veterinary clinics and animal facilities",
    notes:
      "Registration with Bureau of Animal Industry per RA 8485 (Animal Welfare Act)",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1998/02/11/republic-act-no-8485/",
        title: "RA 8485 - Animal Welfare Act of 1998",
        description:
          "Requires BAI registration for veterinary clinics and animal facilities",
      },
    ],
    customFields: [
      {
  ...
  // Agriculture & Fisheries (BFAR)
  {
    ...
    question: null,
    description:
      "Registration with Bureau of Fisheries and Aquatic Resources for fisheries-related businesses",
    ...
    legalBasis: [
      {
        ...
        description:
          "Requires registration with BFAR for fisheries-related businesses",
      },
    ],
    customFields: [
      {
  ...
  // BIR Special Permits
  {
    ...
    question:
      "Does your business offer printing services for official receipts, sales invoices, or other accountable forms for other businesses?",
    description:
      "Authority to Print from BIR for commercial printing of accountable forms",
    notes:
      "Authority to Print issued by BIR per Section 238 of NIRC for commercial printing of ORs/SIs for other taxpayers",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1997/12/11/republic-act-no-8424/",
        title: "RA 8424 - National Internal Revenue Code of 1997",
        description:
          "Section 238 requires Authority to Print for commercial printing of accountable forms",
      },
    ],
    customFields: [
      {
  ...
  // Investment Promotion (BOI/PEZA)
  {
    ...
    description:
      "Registration with Board of Investments for export-oriented or priority projects for tax incentives",
    notes:
      "Registration with Board of Investments for export-oriented or priority projects for tax incentives",
    legalBasis: [
      {
        ...
        description:
          "Provides for BOI registration and tax incentives for priority projects",
      },
    ],
    customFields: [
      {
  ...
  // Agriculture Regulation (BPI)
  {
    ...
    description:
      "Accreditation from Bureau of Plant Industry for plant nursery operators",
    notes:
      "Accreditation issued by Bureau of Plant Industry for plant nursery operators under Seed Industry Development Act (RA 7308)",
    legalBasis: [
      {
  ...
  },
  {
    ...
    question:
      "Does your business sell seeds, planting materials, or agricultural inputs?",
    description:
      "License to Operate from Bureau of Plant Industry for seed dealers and plant material handlers",
    notes:
      "License to Operate issued by Bureau of Plant Industry for seed dealers and plant material handlers",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1992/03/27/republic-act-no-7308/",
        title: "RA 7308 - Seed Industry Development Act of 1992",
        description:
          "Requires BPI license for seed dealers and plant material handlers",
      },
    ],
    customFields: [
      {
  ...
  },
  {
    ...
    notes:
      "Authority to Operate issued by BSP for pawnshops per PD 114 (Pawnshop Regulation Act)",
    legalBasis: [
      {
  ...
  // Financial Regulation (BSP)
  {
    ...
    description:
      "Certificate of Authority from Bangko Sentral ng Pilipinas for banks and financial institutions",
    notes:
      "Certificate of Authority issued by Bangko Sentral ng Pilipinas per RA 8791 (General Banking Law)",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2000/05/23/republic-act-no-8791/",
        title: "RA 8791 - General Banking Law of 2000",
        description:
          "Requires BSP Certificate of Authority for banks and financial institutions",
      },
    ],
    customFields: [
      {
  ...
  // Aviation Regulation (CAAP)
  {
    ...
    question: null,
    description:
      "Height clearance from Civil Aviation Authority of the Philippines for structures near airports",
    notes:
      "Height clearance issued by Civil Aviation Authority of the Philippines",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2008/03/04/republic-act-no-9497/",
        title: "RA 9497 - Civil Aviation Authority Act of 2008",
        description:
          "Requires CAAP height clearance for structures near airports",
      },
    ],
    customFields: [
      {
  ...
  // Aviation Regulation (CAAP)
  {
    ...
    question:
      "Does your business use drones for agricultural spraying or commercial operations?",
    description:
      "RPAS Operator Certificate from Civil Aviation Authority of the Philippines for commercial drone operations",
    notes:
      "RPAS Operator Certificate issued by Civil Aviation Authority of the Philippines for commercial drone operations",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2008/03/04/republic-act-no-9497/",
        title: "RA 9497 - Civil Aviation Authority Act of 2008",
        description:
          "Requires CAAP certificate for commercial drone operations",
      },
    ],
    customFields: [
      {
  ...
  },
  {
    ...
    question: null,
    description:
      "Certificate from DENR for projects not requiring full Environmental Compliance Certificate",
    ...
    legalBasis: [
      {
        ...
        description:
          "Provides for Certificate of Non-Coverage for projects not requiring full Environmental Compliance Certificate",
      },
    ],
    customFields: [
      {
  ...
  // CHED Regulation
  {
    ...
    question:
      "Does your institution offer tertiary education (college/university programs)?",
    description:
      "Recognition or Permit from Commission on Higher Education for tertiary education institutions",
    notes:
      "Recognition or Permit issued by Commission on Higher Education per RA 7722",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1994/05/18/republic-act-no-7722/",
        title: "RA 7722 - Higher Education Act of 1994",
        description:
          "Requires CHED recognition or permit for tertiary education institutions",
      },
    ],
    customFields: [
      {
  ...
  // Congressional Franchise
  {
    ...
    description:
      "Franchise granted by Congress for public utilities (electric, water, telecom)",
    notes:
      "Franchise granted by Congress for public utilities (electric, water, telecom) per 1987 Constitution",
    legalBasis: [
      {
  ...
  // Building Regulation (OBO)
  {
    ...
    description:
      "Permit from Office of the Building Official for demolition work",
    notes:
      "Permit issued by Office of the Building Official for demolition work under National Building Code (PD 1096)",
    legalBasis: [
      {
  ...
  // DENR - Specific CNC for certain businesses
  {
    ...
    question:
      "Does your business discharge wastewater or use chemicals that may impact the environment?",
    description:
      "Certificate of Non-Coverage from DENR-EMB for water discharge compliance",
    notes:
      "Certificate of Non-Coverage from DENR-EMB for water discharge compliance (laundry, clinics, etc.)",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1978/06/11/presidential-decree-no-1586-s-1978/",
        title: "PD 1586 - Environmental Impact Statement System",
        description:
          "Provides for Certificate of Non-Coverage for certain environmental impacts",
      },
    ],
    customFields: [
      {
  ...
  },
  {
    ...
    question:
      "Does your business have air pollution sources (boilers, generators, spray booths)?",
    description: "Permit to Operate from DENR for air pollution sources",
    notes:
      "Permit to Operate for air pollution sources per Clean Air Act (RA 8749)",
    legalBasis: [
      {
  ...
  },
  {
    ...
    question:
      "Does your business manufacture or import new chemical substances?",
    description:
      "Pre-Manufacture Pre-Importation Notification for new chemical substances",
    notes:
      "Notification required for new chemical substances not listed in PICCS per RA 6969",
    legalBasis: [
      {
  ...
  },
  {
    ...
    description:
      "Wastewater Discharge Permit from DENR for facilities with wastewater generation",
    notes:
      "Wastewater Discharge Permit for facilities with wastewater generation per Clean Water Act (RA 9275)",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2004/03/22/republic-act-no-9275/",
        title: "RA 9275 - Philippine Clean Water Act of 2004",
        description:
          "Requires Wastewater Discharge Permit for facilities discharging wastewater",
      },
    ],
    customFields: [
      {
  ...
  // Environmental Permits (DENR - Additional)
  {
    ...
    question:
      "Does your business process lumber, veneer, plywood, or other wood products?",
    description: "Permit from DENR for wood processing plants",
    notes:
      "Permit issued by DENR for wood processing plants per RA 460 and EO 23",
    legalBasis: [
      {
  ...
  // Education Regulation (DepEd - Separate permits)
  {
    ...
    description:
      "Permit from Department of Education for basic education institutions",
    notes:
      "Permit issued by DepEd for basic education institutions, valid for 1 school year per RA 9155",
    legalBasis: [
      {
  ...
  },
  {
    ...
    question: null,
    description:
      "Recognition from Department of Education for schools with complete basic education programs",
    notes:
      "Recognition issued by DepEd for schools with complete basic education programs, valid for life of corporation",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2001/08/11/republic-act-no-9155/",
        title: "RA 9155 - Governance of Basic Education Act of 2001",
        description:
          "Provides for DepEd recognition of schools with complete programs",
      },
    ],
    customFields: [
      {
  ...
  // Education Regulation (DepEd/CHED/TESDA)
  {
    ...
    question: null,
    description:
      "Permit from Department of Education or Commission on Higher Education for educational institutions",
    notes:
      "Permit issued by Department of Education or Commission on Higher Education",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1982/08/20/batas-pambansa-blg-232/",
        title: "BP 232 - Education Act of 1982",
        description:
          "Requires permits for educational institutions from DepEd or CHED",
      },
    ],
    customFields: [
      {
  ...
  },
  {
    ...
    question:
      "Does your brokerage deal with subdivision or condominium projects?",
    description:
      "Registration with DHSUD for brokers dealing with subdivision or condominium projects",
    notes:
      "Registration with DHSUD for brokers dealing with subdivision/condo projects per PD 957",
    legalBasis: [
      {
        ...
        description:
          "Requires DHSUD registration for brokers dealing with subdivision/condo projects",
      },
    ],
    customFields: [
      {
  ...
  },
  {
    ...
    description:
      "License to Sell from DHSUD for subdivision or condominium developers",
    notes:
      "License to Sell issued by DHSUD before marketing subdivision/condo units per PD 957",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1976/07/12/presidential-decree-no-957-s-1976/",
        title: "PD 957 - Subdivision and Condominium Buyer's Protective Decree",
        description:
          "Requires DHSUD License to Sell before marketing subdivision/condo units",
      },
    ],
    customFields: [
      {
  ...
  },
  {
    ...
    question: null,
    description:
      "Project registration with Department of Human Settlements and Urban Development",
    notes:
      "Project registration issued by Department of Human Settlements and Urban Development",
    legalBasis: [
      {
  ...
  // ICT Regulation (DICT)
  {
    ...
    description:
      "Authority to Operate from DICT for Private Express and Messengerial Delivery Services",
    notes:
      "Authority to Operate issued by DICT for Private Express and Messengerial Delivery Services under PD 240 and RA 10844",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1973/07/02/presidential-decree-no-240-s-1973/",
        title: "PD 240 - Postal Service Code",
        description:
          "Requires DICT authority for Private Express and Messengerial Delivery Services",
      },
      {
  ...
  },
  {
    ...
    name: "DMW License",
    question:
      "Does your business recruit Filipino workers for overseas employment?",
    description:
      "License from Department of Migrant Workers for overseas recruitment agencies",
    notes:
      "License issued by Department of Migrant Workers for overseas recruitment agencies per RA 8042",
    legalBasis: [
      {
  ...
  // Energy Regulation (DOE)
  {
    ...
    question: null,
    description:
      "Certificate of Compliance from Department of Energy for downstream oil industry participants",
    ...
    legalBasis: [
      {
        ...
        description:
          "Requires DOE Certificate of Compliance for downstream oil industry participants",
      },
    ],
    customFields: [
      {
  ...
  // Health Regulation (DOH - Specific LTO)
  {
    ...
    description:
      "License to Operate from Department of Health for health facilities",
    notes:
      "License to Operate issued by DOH for health facilities per RA 4226 (Hospital Licensure Act)",
    legalBasis: [
      {
  ...
  // Health Regulation (DOH - Operating Permit)
  {
    ...
    question:
      "Is your business engaged in refuse collection or disposal services?",
    description:
      "Operating Permit from regional health office for refuse collection and disposal services",
    notes:
      "Operating Permit issued by regional health office for refuse collection and disposal services per PD 856 (Code of Sanitation)",
    legalBasis: [
      {
        ...
        description:
          "Requires DOH operating permit for refuse collection and disposal services",
      },
    ],
    customFields: [
      {
  ...
  },
  {
    ...
    question: null,
    description:
      "Permit from Department of Health for health-related establishments",
    ...
    legalBasis: [
      {
        ...
        title: "PD 856 - Code of Sanitation of the Philippines",
        description:
          "Authorizes DOH to issue health permits for establishments",
      },
    ],
    customFields: [
      {
  ...
  },
  {
    ...
    question:
      "Are you constructing a new hospital or making substantial alterations to an existing one?",
    description:
      "Permit to Construct from DOH for new hospitals or major renovations",
    notes:
      "Permit to Construct issued by DOH for new hospitals or major renovations per DOH AO 150-2004",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1965/06/19/republic-act-no-4226/",
        title: "RA 4226 - Hospital Licensure Act",
        description:
          "Requires DOH Permit to Construct for new hospitals or major renovations",
      },
    ],
    customFields: [
      {
  ...
  // Labor Regulation (DOLE/DMW)
  {
    ...
    description:
      "Registration with Department of Labor and Employment for legitimate job contracting",
    notes:
      "Registration with DOLE under Department Order No. 174-17 for legitimate job contracting",
    legalBasis: [
      {
        ...
        description:
          "Requires DOLE registration for legitimate job contracting",
      },
    ],
    customFields: [
      {
  ...
  // Tourism Regulation (DOT)
  {
    ...
    question:
      "Is your business a tourism enterprise (hotel, resort, travel agency, tour operator)?",
    description:
      "Accreditation from Department of Tourism for tourism enterprises",
    notes:
      "Accreditation issued by Department of Tourism for tourism enterprises - optional but industry standard",
    legalBasis: [
      {
  ...
  // Social Welfare (DSWD)
  {
    ...
    question: null,
    description:
      "Permit from Department of Social Welfare and Development for social welfare agencies",
    ...
    legalBasis: [
      {
        ...
        description:
          "Authorizes DSWD to issue permits for social welfare agencies",
      },
    ],
    customFields: [
      {
  ...
  // DTI Accreditation
  {
    ...
    question: null,
    description:
      "Accreditation from DTI for repair shops and other specialized services",
    notes:
      "Accreditation issued by DTI for repair shops and other specialized services (required by some LGUs)",
    legalBasis: [
      {
        ...
        description:
          "Authorizes DTI accreditation for specialized service providers",
      },
    ],
    customFields: [
      {
  ...
  // Trade Regulation (DTI - Freight Forwarding)
  {
    ...
    notes:
      "Mandatory accreditation issued by DTI under Department Administrative Order No. 24-09",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2003/11/07/republic-act-no-8483/",
        title: "RA 8483 - Revised Consumer Act of the Philippines",
  ...
  },
  {
    ...
    description:
      "Registration with Garments and Textile Industry Development Office for export-oriented manufacturers",
    notes:
      "Registration with Garments and Textile Industry Development Office for export-oriented manufacturers",
    legalBasis: [
      {
        ...
        description:
          "Requires GTIDO registration for export-oriented manufacturers",
      },
    ],
    customFields: [
      {
  ...
  },
  {
    ...
    notes:
      "Additional activity on existing LTO or separate pure E-Pharmacy LTO for online operations",
    legalBasis: [
      {
        ...
        description:
          "Requires LTO for e-pharmacy operations per FDA guidelines",
      },
    ],
    customFields: [
      {
  ...
  // Environmental Permits (DENR)
  {
    ...
    question: null,
    description:
      "Certificate from Department of Environment and Natural Resources for projects with significant environmental impact",
    notes:
      "Certificate issued by DENR for projects with significant environmental impact",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1978/06/11/presidential-decree-no-1586-s-1978/",
        title: "PD 1586 - Environmental Impact Statement System",
        description:
          "Establishes the Environmental Impact Statement System including the requirement for Environmental Compliance Certificates",
      },
    ],
    customFields: [
      {
  ...
  },
  {
    ...
    question: null,
    description:
      "Certificate from Energy Regulatory Commission for electricity-related activities",
    ...
    legalBasis: [
      {
        ...
        description:
          "Requires ERC certificate for electricity-related activities",
      },
    ],
    customFields: [
      {
  ...
  // Energy Regulation (ERC)
  {
    ...
    description:
      "Certificate of Public Convenience and Necessity from Energy Regulatory Commission for power distributors",
    notes:
      "Certificate of Public Convenience and Necessity issued by Energy Regulatory Commission",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2001/06/08/republic-act-no-9136/",
        title: "RA 9136 - Electric Power Industry Reform Act of 2001",
        description:
          "Requires ERC Certificate of Public Convenience and Necessity for power distributors",
      },
    ],
    customFields: [
      {
  ...
  // Food & Drug Regulation (FDA/DOH)
  {
    ...
    question: null,
    description:
      "License to Operate from Food and Drug Administration for health product establishments",
    ...
    legalBasis: [
      {
        ...
        title: "RA 9711 - Food and Drug Administration Act of 2009",
        description:
          "Establishes the FDA and requires LTO for establishments handling food, drugs, cosmetics, and medical devices",
      },
    ],
    customFields: [
      {
  ...
  // Pesticide Regulation (FPA)
  {
    ...
    description:
      "License from Fertilizer and Pesticide Authority for commercial pesticide applicators",
    notes:
      "License issued by Fertilizer and Pesticide Authority for commercial pesticide applicators",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2009/08/18/republic-act-no-9711/",
        title: "RA 9711 - Food and Drug Administration Act of 2009",
        description:
          "FPA under FDA requires license for commercial pesticide applicators",
      },
    ],
    customFields: [
      {
  ...
  },
  {
    ...
    question: null,
    description:
      "License to Operate from Fertilizer and Pesticide Authority for fertilizer and pesticide handlers",
    notes:
      "License to Operate issued by Fertilizer and Pesticide Authority for fertilizer and pesticide handlers",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2009/08/18/republic-act-no-9711/",
        title: "RA 9711 - Food and Drug Administration Act of 2009",
        description:
          "FPA under FDA requires LTO for fertilizer and pesticide establishments",
      },
    ],
    customFields: [
      {
  ...
  // Real Estate Regulation (DHSUD/HLURB)
  {
    ...
    question: null,
    description:
      "Registration with Housing and Land Use Regulatory Board for real estate projects",
  ...
  // Local Government Permits (Health/Safety/Zoning)
  {
    ...
    notes:
      "License issued by LGU for establishments serving alcohol under local tax ordinances",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1991/10/10/republic-act-no-7160/",
        title: "RA 7160 - Local Government Code of 1991",
        description:
          "Authorizes LGUs to issue liquor licenses under local tax ordinances",
      },
    ],
    customFields: [
      {
  ...
  // Environmental Regulation (LLDA)
  {
    ...
    question:
      "Is your business located in the Laguna de Bay Region and discharges liquid waste?",
    description:
      "Discharge Permit from Laguna Lake Development Authority for liquid waste discharge",
    notes:
      "Discharge Permit issued by Laguna Lake Development Authority under RA 4850",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1966/06/18/republic-act-no-4850/",
        title: "RA 4850 - Laguna Lake Development Authority Act",
        description:
          "Requires LLDA Discharge Permit for liquid waste discharge in Laguna de Bay Region",
      },
    ],
    customFields: [
      {
  ...
  // Transportation Regulation (LTFRB)
  {
    ...
    question:
      "Does your business operate public utility vehicles (bus, taxi, jeepney, truck-for-hire)?",
    description:
      "Certificate of Public Convenience from LTFRB for public transport",
    notes:
      "Certificate of Public Convenience issued by LTFRB for public transport under Commonwealth Act 146",
    legalBasis: [
      {
  ...
  // Transportation Regulation (LTFRB)
  {
    ...
    question: null,
    description:
      "Franchise from Land Transportation Franchising and Regulatory Board for public utility vehicles",
    notes:
      "Franchise issued by Land Transportation Franchising and Regulatory Board",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1964/06/15/republic-act-no-4160/",
        title:
          "RA 4160 - An Act to Reorganize the Land Transportation Commission",
        description:
          "Authorizes LTFRB to issue franchises for public utility vehicles",
      },
    ],
    customFields: [
      {
  ...
  // Transportation & Driving (LTO)
  {
    ...
    question: null,
    description:
      "Accreditation from Land Transportation Office for transportation-related establishments",
    ...
    legalBasis: [
      {
        ...
        description:
          "Authorizes LTO to accredit transportation-related establishments",
      },
    ],
    customFields: [
      {
  ...
  },
  {
    ...
    question:
      "Does your business operate motor vehicles (trucks, PUVs, delivery vehicles)?",
    description:
      "Vehicle registration from Land Transportation Office for each motor vehicle",
    notes:
      "Vehicle registration issued by Land Transportation Office for each motor vehicle per RA 4136",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1964/06/15/republic-act-no-4136/",
        title: "RA 4136 - Land Transportation and Traffic Code",
        description:
          "Requires vehicle registration with LTO for all motor vehicles",
      },
    ],
    customFields: [
      {
  ...
  },
  {
    ...
    notes:
      "Separate LTO from FDA as Retailer of Medical Devices per FDA Circular No. 2021-0021",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2009/08/18/republic-act-no-9711/",
        title: "RA 9711 - Food and Drug Administration Act of 2009",
        description:
          "Requires separate LTO for medical device retailers per FDA Circular No. 2021-0021",
      },
    ],
    customFields: [
      {
  ...
  // Mining Regulation (MGB)
  {
    ...
    description:
      "Exploration Permit from Mines and Geosciences Bureau for mining exploration",
    notes:
      "Exploration Permit issued by Mines and Geosciences Bureau under RA 7942 (Philippine Mining Act)",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1995/03/03/republic-act-no-7942/",
        title: "RA 7942 - Philippine Mining Act of 1995",
  ...
  },
  {
    ...
    notes:
      "Mineral Agreement issued by MGB for production operations under RA 7942",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1995/03/03/republic-act-no-7942/",
        title: "RA 7942 - Philippine Mining Act of 1995",
        description:
          "Requires MGB Mineral Agreement for mining production operations",
      },
    ],
    customFields: [
      {
  ...
  },
  {
    ...
    question: null,
    description:
      "Permit from Mines and Geosciences Bureau for mining-related activities",
    ...
    legalBasis: [
      {
        ...
        title: "RA 7942 - Philippine Mining Act of 1995",
        description:
          "Authorizes MGB to issue various mining permits and licenses",
      },
    ],
    customFields: [
      {
  ...
  // Publishing Regulation (NBDB)
  {
    ...
    description:
      "Registration with National Book Development Board for ISBN issuance and incentives",
    notes:
      "Registration with National Book Development Board for ISBN issuance and incentives per RA 8047",
    legalBasis: [
      {
  ...
  },
  {
    ...
    question:
      "Is your business a rice retailer with annual sales exceeding ₱2 million?",
    description:
      "Accreditation from National Food Authority for large rice retailers",
    notes:
      "Accreditation issued by National Food Authority for large rice retailers per RA 10611",
    legalBasis: [
      {
  ...
  // Food Regulation (NFA)
  {
    ...
    name: "NFA License",
    question:
      "Is your rice/corn mill engaged in bonded activities (accepting third-party stocks)?",
    description:
      "Grains Bonded Business License from National Food Authority for mills accepting third-party stocks",
    notes:
      "Grains Bonded Business License issued by National Food Authority for mills accepting third-party stocks",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2013/08/23/republic-act-no-10611/",
        title: "RA 10611 - Food Safety Act of 2013",
  ...
  },
  {
    ...
    question:
      "Is your business engaged in rice/corn milling or related grains business?",
    description:
      "Registration with National Food Authority for grains business operations",
    notes:
      "Registration with National Food Authority for grains business operations under RA 10611",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2013/08/23/republic-act-no-10611/",
        title: "RA 10611 - Food Safety Act of 2013",
  ...
  },
  {
    ...
    description:
      "Accreditation from National Meat Inspection Service for meat handlers and vendors",
    notes:
      "Accreditation issued by National Meat Inspection Service for meat handlers and vendors per RA 9296",
    legalBasis: [
      {
        ...
        description:
          "Requires NMIS accreditation for meat handlers and vendors",
      },
    ],
    customFields: [
      {
  ...
  },
  {
    ...
    question: null,
    description:
      "Permit from DENR/Mines and Geosciences Bureau for non-metallic mining operations",
  ...
  // Data Privacy Regulation (NPC)
  {
    ...
    question:
      "Does your business process personal data as a Personal Information Controller?",
    description:
      "Registration with National Privacy Commission for Personal Information Controllers",
    notes:
      "Registration with National Privacy Commission per RA 10173 (Data Privacy Act)",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2012/08/15/republic-act-no-10173/",
        title: "RA 10173 - Data Privacy Act of 2012",
        description:
          "Requires NPC registration for Personal Information Controllers",
      },
    ],
    customFields: [
      {
  ...
  // Telecommunications Regulation (NTC)
  {
    ...
    description:
      "Certificate of Public Convenience and Necessity from NTC for telecom services",
    notes:
      "Certificate of Public Convenience and Necessity issued by NTC for telecom services",
    legalBasis: [
      {
  ...
  },
  {
    ...
    question: null,
    description:
      "Certificate of Registration from National Telecommunications Commission for telecommunications equipment and services",
    notes:
      "Certificate of Registration issued by National Telecommunications Commission",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1936/11/07/commonwealth-act-no-146/",
        title: "CA 146 - Public Service Act",
        description:
          "Requires NTC registration for telecommunications equipment and services",
      },
    ],
    customFields: [
      {
  ...
  // Telecommunications Regulation (NTC)
  {
    ...
    question: null,
    description:
      "Provisional Authority or Certificate of Public Convenience and Necessity from NTC",
    notes:
      "Provisional Authority or Certificate of Public Convenience and Necessity issued by NTC",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1936/11/07/commonwealth-act-no-146/",
        title: "CA 146 - Public Service Act",
  ...
  // Water Utilities Regulation (NWRB)
  {
    ...
    description:
      "Certificate of Public Convenience from NWRB for water utilities",
    notes:
      "Certificate of Public Convenience issued by NWRB for water utilities under PD 1067 (Water Code)",
    legalBasis: [
      {
  ...
  // Utilities Regulation (NWRB/ERC)
  {
    ...
    question: null,
    description:
      "Water permit from National Water Resources Board for water use and extraction",
    ...
    legalBasis: [
      {
        ...
        title: "PD 1067 - Water Code of the Philippines",
        description:
          "Requires water permit from NWRB for water use and extraction",
      },
    ],
    customFields: [
      {
  ...
  // Construction Regulation (PCAB)
  {
    ...
    question: null,
    description:
      "License from Philippine Contractors Accreditation Board for construction contractors",
  ...
  // PDEA Regulation
  {
    ...
    description:
      "S2 License from Philippine Drug Enforcement Agency for facilities handling controlled substances",
    notes:
      "S2 License issued by Philippine Drug Enforcement Agency for facilities handling controlled substances",
    legalBasis: [
      {
        ...
        description:
          "Requires PDEA S2 license for facilities handling controlled substances",
      },
    ],
    customFields: [
      {
  ...
  },
  {
    ...
    question:
      "Is your business located in or operating within an economic zone?",
    description:
      "Registration with Philippine Economic Zone Authority for economic zone locators",
    notes:
      "Registration with Philippine Economic Zone Authority for economic zone locators",
    legalBasis: [
      {
        ...
        description:
          "Authorizes PEZA to register and oversee economic zone enterprises",
      },
    ],
    customFields: [
      {
  ...
  },
  {
    ...
    notes:
      "PRC license for pharmacist-in-charge required per RA 10918 Philippine Pharmacy Act",
    legalBasis: [
      {
  ...
  // PhilHealth Accreditation
  {
    ...
    description:
      "Accreditation from PhilHealth for health facilities participating in the National Health Insurance Program",
    notes:
      "Accreditation issued by PhilHealth for health facilities participating in the National Health Insurance Program",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1995/02/24/republic-act-no-7875/",
        title: "RA 7875 - National Health Insurance Act of 1995",
        description:
          "Provides for PhilHealth accreditation of health facilities",
      },
    ],
    customFields: [
      {
  ...
  // PNP Firearms and Explosives Office (FEO)
  {
    ...
    question:
      "Does your business manufacture, sell, distribute, or display fireworks/pyrotechnics?",
    description:
      "License/Permit from PNP-FEO for fireworks/pyrotechnics businesses",
    notes:
      "License/Permit issued by PNP-FEO for fireworks/pyrotechnics per RA 7183 (Manufacturer, Dealer, Retailer, or Display Operator)",
    legalBasis: [
      {
        ...
        description:
          "Requires PNP-FEO license for fireworks/pyrotechnics businesses",
      },
    ],
    customFields: [
      {
  ...
  // Security Regulation (PNP)
  {
    ...
    question: null,
    description:
      "License from Philippine National Police for security agencies",
  ...
  // Professional Regulation (PRC - Specific Licenses)
  {
    ...
    notes:
      "PRC license for electrical engineers (Professional Electrical Engineer, Registered Electrical Engineer, Registered Master Electrician) per RA 7920",
    legalBasis: [
      {
  ...
  // Professional Regulation (PRC)
  {
    ...
    question: null,
    description:
      "Professional license from Professional Regulation Commission for regulated professions",
  ...
  // Real Estate Regulation (PRC/DHSUD)
  {
    ...
    notes:
      "License issued by PRC for real estate brokers per RA 9646 (Real Estate Service Act)",
    legalBasis: [
      {
  ...
  },
  {
    ...
    question: null,
    description:
      "Permit from DENR/Mines and Geosciences Bureau for quarry operations",
    ...
    legalBasis: [
      {
        ...
        title: "RA 7942 - Philippine Mining Act of 1995",
        description:
          "Governs the exploration, development, utilization, and processing of mineral resources including quarry permits",
      },
    ],
    customFields: [
      {
  ...
  // Education Regulation (School Transport)
  {
    ...
    description:
      "Certificate from school administrator/PTA for school transport services",
    notes:
      "Certificate from school administrator/PTA required for school transport services per LTFRB guidelines",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1936/11/07/commonwealth-act-no-146/",
        title: "CA 146 - Public Service Act",
        description:
          "Requires school accreditation for school transport services per LTFRB guidelines",
      },
    ],
    customFields: [
      {
  ...
  // SEC - Certificate of Authority for Lending/Financing
  {
    ...
    description:
      "Certificate of Authority from SEC for lending or financing companies",
    notes:
      "Certificate of Authority issued by SEC for lending companies per RA 9474 or financing companies per RA 8556",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2007/06/13/republic-act-no-9474/",
        title: "RA 9474 - Lending Company Regulation Act of 2007",
        description:
          "Requires SEC Certificate of Authority for lending companies",
      },
      {
        url: "https://www.officialgazette.gov.ph/1998/02/11/republic-act-no-8556/",
        title: "RA 8556 - Financing Company Act of 1998",
        description:
          "Requires SEC Certificate of Authority for financing companies",
      },
    ],
    customFields: [
      {
  ...
  // Local Government Permits (City Engineering Office)
  {
    ...
    notes:
      "Permit issued by City Engineering Office for business signage - checked during inspection",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1991/10/10/republic-act-no-7160/",
        title: "RA 7160 - Local Government Code of 1991",
  ...
  },
  {
    ...
    question: null,
    description:
      "Registration with Technical Education and Skills Development Authority for technical-vocational institutions",
    notes:
      "Registration issued by Technical Education and Skills Development Authority",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1994/08/27/republic-act-no-7796/",
        title: "RA 7796 - TESDA Act of 1994",
        description:
          "Authorizes TESDA to register technical-vocational institutions",
      },
    ],
    customFields: [
      {
  ...
  // Trade Regulation (DTI)
  {
    ...
    notes:
      "Seal issued by DTI for weighing scales and measuring devices - checked during inspection",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2003/11/07/republic-act-no-8483/",
        title: "RA 8483 - Revised Consumer Act of the Philippines",
        description:
          "Requires DTI seal for weighing scales and measuring devices",
      },
    ],
    customFields: [
      {
...
async function seedPostRequirements() {
  try {
    ...
    for (const pr of POST_REQUIREMENTS) {
      ...
      console.log(
        `Created PostRequirement: ${pr._id} - ${pr.name}${pr.customFields?.length ? ` (${pr.customFields.length} custom fields)` : ""}`,
      );
    }

    console.log(
      `Created ${postRequirementDocs.length} PostRequirement documents`,
    );
    ...
    const POST_REQUIREMENT_CHECKLIST_MAP = {
      ...
      "BSP Authority to Operate (Pawnshop)":
        "BSP Pawnshop Authority Compliance",
      "BSP Certificate of Authority": "BSP Certificate Authority Compliance",
      // Batch 2 mappings
      "CAAP Height Clearance": "CAAP Height Clearance Compliance",
      "CAAP RPAS Operator Certificate":
        "CAAP RPAS Operator Certificate Compliance",
      ...
      "DENR PMPIN (Pre-Manufacture Pre-Importation Notification)":
        "DENR PMPIN Compliance",
      "DENR Wastewater Discharge Permit":
        "DENR Wastewater Discharge Permit Compliance",
      "DENR Wood Processing Plant Permit":
        "DENR Wood Processing Permit Compliance",
      ...
      "DOE Certificate of Compliance":
        "DOE Certificate of Compliance Compliance",
      ...
      "DTI Freight Forwarding Accreditation":
        "DTI Freight Forwarding Accreditation Compliance",
      ...
      "ERC Certificate of Public Convenience and Necessity":
        "ERC CPCN Compliance",
      "FPA Commercial Applicator License":
        "FPA Commercial Applicator License Compliance",
      ...
      "NTC Certificate of Public Convenience and Necessity":
        "NTC CPCN Compliance",
      ...
      "Pharmacist-in-Charge Credential":
        "Pharmacist in Charge Credential Compliance",
    ...
    for (const lob of lobs) {
      const mapping = LOB_POST_REQUIREMENT_MAPPINGS[lob.name] || {
        required: [],
        conditional: [],
      };

      // Convert code strings to ObjectIds
      const requiredIds = mapping.required
        .map((code) => codeToIdMap[code])
        .filter((id) => id);
      const conditionalIds = mapping.conditional
        .map((code) => codeToIdMap[code])
        .filter((id) => id);
      ...
      await lob.save();
      console.log(
        `Updated LOB: ${lob.code} - ${lob.name} (${requiredIds.length} required, ${conditionalIds.length} conditional)`,
      );
    }
