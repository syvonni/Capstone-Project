  ...
  try {
    ...
    const businessResult = await mongoose.connection
      ...
      .updateMany(
        ...
        { $set: { applicationStatus: "needs_revision" } },
      );
    console.log(
      `Updated ${businessResult.modifiedCount} Business records from 'returned' to 'needs_revision'`,
    );
    ...
    console.log(
      `Updated ${applicationResult.modifiedCount} Application records from 'returned' to 'needs_revision'`,
    );
    ...
    console.log(
      `Updated ${profileResult.modifiedCount} BusinessProfile records from 'returned' to 'needs_revision'`,
    );
