...
const POST_REQUIREMENT_CHECKLISTS = [
  // Batch 1: AMLC, Animal Welfare, ATH, BAI, BFAR, BIR ATP, BOI, BPI, BSP
  {
    ...
    notes:
      "Covers AMLC registration requirements under RA 9160 for covered persons",
    legalBasis: [
      {
  ...
  },
  {
    ...
    notes:
      "Covers Animal Welfare Seminar certificate requirements under RA 8485",
    legalBasis: [
      {
  ...
  },
  {
    ...
    notes:
      "Covers Authorization to Haul requirements under RA 7942 for mineral product transport",
    legalBasis: [
      {
  ...
  },
  {
    ...
    notes:
      "Covers BAI registration requirements under RA 8485 for veterinary clinics and animal facilities",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1998/02/11/republic-act-no-8485/",
        title: "RA 8485 - Animal Welfare Act of 1998",
    ...
    items: [{ inspectionItemName: "BAI Registration", order: 1 }],
  },
  {
    name: "BFAR Registration Compliance",
    description: "BFAR registration checklist",
    notes:
      "Covers BFAR registration requirements under RA 8550 for fisheries-related businesses",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "BFAR Registration", order: 1 }],
  },
  {
    name: "BIR Authority to Print Compliance",
    description: "BIR Authority to Print validity checklist",
    notes:
      "Covers BIR Authority to Print requirements under RA 8424 for commercial printing of accountable forms",
    legalBasis: [
      {
  ...
  },
  {
    ...
    notes:
      "Covers BOI registration requirements under EO 226 for export-oriented or priority projects",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "BOI Registration", order: 1 }],
  },
  {
    name: "BPI Accreditation Compliance",
    description: "BPI accreditation checklist",
    notes:
      "Covers BPI accreditation requirements under RA 7308 for plant nursery operators",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "BPI Accreditation", order: 1 }],
  },
  {
    name: "BPI License Compliance",
    description: "BPI license checklist",
    notes:
      "Covers BPI license requirements under RA 7308 for plant-related operations",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1992/03/27/republic-act-no-7308/",
        title: "RA 7308 - Seed Industry Development Act of 1992",
    ...
    items: [{ inspectionItemName: "BPI License", order: 1 }],
  },
  {
    ...
    items: [{ inspectionItemName: "BSP Pawnshop Authority", order: 1 }],
  },
  {
    name: "BSP Certificate Authority Compliance",
    description: "BSP Certificate of Authority checklist",
    notes:
      "Covers BSP Certificate of Authority requirements for financial operations",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "BSP Certificate Authority", order: 1 }],
  },
  // Batch 2: CAAP, CNC, CHED, Congressional Franchise, Demolition Permit, DENR permits, DepEd permits, DHSUD permits, DICT, DMW, DOE, DOH permits, DOLE, DOT, DSWD, DTI permits, E-pharmacy
  {
    ...
    notes:
      "Covers CAAP height clearance requirements under RA 9497 for structures near airports",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "CAAP Height Clearance", order: 1 }],
  },
  {
    ...
    items: [{ inspectionItemName: "CAAP RPAS Operator Certificate", order: 1 }],
  },
  {
    name: "CNC Compliance",
    description: "Certificate of Non-Coverage validity checklist",
    notes:
      "Covers CNC requirements under PD 1586 for projects not requiring ECC",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "Certificate of Non-Coverage", order: 1 }],
  },
  {
    name: "CHED Recognition Permit Compliance",
    description: "CHED Recognition Permit validity checklist",
    notes:
      "Covers CHED recognition requirements under RA 7722 for higher education institutions",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "CHED Recognition Permit", order: 1 }],
  },
  {
    name: "Congressional Franchise Compliance",
    description: "Congressional Franchise validity checklist",
    notes:
      "Covers congressional franchise requirements under 1987 Constitution for public utilities",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "Congressional Franchise", order: 1 }],
  },
  {
    ...
    items: [{ inspectionItemName: "Demolition Permit", order: 1 }],
  },
  {
  ...
  },
  {
    ...
    notes:
      "Covers PTO-AIR requirements under PD 1181 for air pollution sources",
    legalBasis: [
      {
    ...
    items: [
      {
        inspectionItemName: "DENR Permit to Operate Air Installation",
        order: 1,
      },
    ],
  },
  {
    ...
    description:
      "DENR Pollution Management Program Implementation Notice validity checklist",
    ...
    items: [
      {
        inspectionItemName:
          "DENR Pollution Management Program Implementation Notice",
        order: 1,
      },
    ],
  },
  ...
  },
  {
    ...
    items: [{ inspectionItemName: "DENR Wood Processing Permit", order: 1 }],
  },
  {
    name: "DepEd Permit Compliance",
    description: "DepEd Permit validity checklist",
    notes:
      "Covers DepEd permit requirements under BP 232 for educational institutions",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "DepEd Permit", order: 1 }],
  },
  {
    ...
    items: [{ inspectionItemName: "DepEd Recognition", order: 1 }],
  },
  {
    ...
    items: [{ inspectionItemName: "DepEd-CHED Joint Permit", order: 1 }],
  },
  {
    ...
    items: [{ inspectionItemName: "DHSUD Broker Registration", order: 1 }],
  },
  {
    name: "DHSUD License to Sell Compliance",
    description: "DHSUD License to Sell validity checklist",
    notes:
      "Covers license to sell requirements under RA 9646 for real estate projects",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2019/02/14/republic-act-no-9646/",
        title: "RA 9646 - Real Estate Service Act",
    ...
    items: [{ inspectionItemName: "DHSUD License to Sell", order: 1 }],
  },
  {
    name: "DHSUD Project Registration Compliance",
    description: "DHSUD Project Registration validity checklist",
    notes:
      "Covers project registration requirements under RA 9646 for housing projects",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2019/02/14/republic-act-no-9646/",
        title: "RA 9646 - Real Estate Service Act",
    ...
    items: [{ inspectionItemName: "DHSUD Project Registration", order: 1 }],
  },
  {
    name: "DICT PEMEDES Authority Compliance",
    description: "DICT PEMEDES Authority validity checklist",
    notes:
      "Covers PEMEDES authority requirements under RA 11223 for medical device establishments",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "DICT PEMEDES Authority", order: 1 }],
  },
  {
    name: "DMW License Compliance",
    description: "DMW License validity checklist",
    notes:
      "Covers DMW license requirements under RA 8042 for recruitment agencies",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "DMW License", order: 1 }],
  },
  {
    name: "DOE Certificate of Compliance Compliance",
    description: "DOE Certificate of Compliance validity checklist",
    notes:
      "Covers DOE COC requirements under RA 9136 for energy-related facilities",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "DOE Certificate of Compliance", order: 1 }],
  },
  {
    ...
    items: [{ inspectionItemName: "DOH License to Operate", order: 1 }],
  },
  {
    name: "DOH Operating Permit Compliance",
    description: "DOH Operating Permit validity checklist",
    notes:
      "Covers operating permit requirements under RA 11223 for health establishments",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2018/12/20/republic-act-no-11223/",
        title: "RA 11223 - Universal Health Care Act",
    ...
    items: [{ inspectionItemName: "DOH Operating Permit", order: 1 }],
  },
  {
    name: "DOH Permit Compliance",
    description: "DOH Permit validity checklist",
    notes:
      "Covers DOH permit requirements under RA 11223 for health-related businesses",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2018/12/20/republic-act-no-11223/",
        title: "RA 11223 - Universal Health Care Act",
    ...
    items: [{ inspectionItemName: "DOH Permit", order: 1 }],
  },
  {
    name: "DOH Permit to Construct Compliance",
    description: "DOH Permit to Construct validity checklist",
    notes:
      "Covers permit to construct requirements under RA 11223 for health facility construction",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2018/12/20/republic-act-no-11223/",
        title: "RA 11223 - Universal Health Care Act",
    ...
    items: [{ inspectionItemName: "DOH Permit to Construct", order: 1 }],
  },
  {
    ...
    items: [{ inspectionItemName: "DOLE Registration DO174", order: 1 }],
  },
  {
    name: "DOT Accreditation Compliance",
    description: "DOT Accreditation validity checklist",
    notes:
      "Covers DOT accreditation requirements under RA 9593 for tourism establishments",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "DOT Accreditation", order: 1 }],
  },
  {
    name: "DSWD Permit Compliance",
    description: "DSWD Permit validity checklist",
    notes:
      "Covers DSWD permit requirements under RA 8432 for social welfare agencies",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "DSWD Permit", order: 1 }],
  },
  {
    ...
    items: [{ inspectionItemName: "DTI Accreditation", order: 1 }],
  },
  {
    name: "DTI Freight Forwarding Accreditation Compliance",
    description: "DTI Freight Forwarding Accreditation validity checklist",
    notes:
      "Covers freight forwarding accreditation requirements for logistics companies",
    legalBasis: [
      {
        url: "https://www.dti.gov.ph/",
  ...
  },
  {
    ...
    items: [{ inspectionItemName: "DTI GTIDO Registration", order: 1 }],
  },
  {
    name: "E-Pharmacy LTO Compliance",
    description: "E-Pharmacy License to Operate validity checklist",
    notes:
      "Covers e-pharmacy LTO requirements under RA 9711 for online pharmacies",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "E-Pharmacy License to Operate", order: 1 }],
  },
  // Batch 3: ERC, FPA, HLURB, Liquor License, LLDA, LTFRB, LTO, Medical Device Retailer, MGB permits, NBDB, NFA, NMIS, NPC, NTC, NWRB
  {
    ...
    notes:
      "Covers ERC certificate requirements under RA 9136 for energy-related operations",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2001/06/08/republic-act-no-9136/",
        title: "RA 9136 - Electric Power Industry Reform Act",
    ...
    items: [{ inspectionItemName: "ERC Certificate", order: 1 }],
  },
  {
    name: "ERC CPCN Compliance",
    description:
      "ERC Certificate of Public Convenience and Necessity validity checklist",
    notes:
      "Covers ERC CPCN requirements under RA 9136 for public utility operations",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2001/06/08/republic-act-no-9136/",
        title: "RA 9136 - Electric Power Industry Reform Act",
  ...
  },
  {
    ...
    notes:
      "Covers FPA LTO requirements for fertilizer and pesticide businesses",
    legalBasis: [
      {
        url: "https://www.fpa.gov.ph/",
        title: "FPA Act of 1977",
    ...
    items: [{ inspectionItemName: "FPA License to Operate", order: 1 }],
  },
  {
    name: "HLURB Registration Compliance",
    description: "HLURB Registration validity checklist",
    notes:
      "Covers HLURB registration requirements under RA 11201 for housing projects",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "HLURB Registration", order: 1 }],
  },
  {
    name: "Liquor License Compliance",
    description: "Liquor License validity checklist",
    notes:
      "Covers liquor license requirements for establishments serving alcoholic beverages",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "Liquor License", order: 1 }],
  },
  {
    name: "LLDA Discharge Permit Compliance",
    description: "LLDA Discharge Permit validity checklist",
    notes:
      "Covers LLDA discharge permit requirements for facilities discharging into Laguna Lake",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "LLDA Discharge Permit", order: 1 }],
  },
  {
    name: "LTFRB CPC Compliance",
    description: "LTFRB Certificate of Public Convenience validity checklist",
    notes:
      "Covers LTFRB CPC requirements under RA 10149 for public transportation operations",
    legalBasis: [
      {
    ...
    items: [
      {
        inspectionItemName: "LTFRB Certificate of Public Convenience",
        order: 1,
      },
    ],
  },
  {
    ...
    notes:
      "Covers LTFRB franchise requirements under RA 10149 for PUV operations",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2015/07/21/republic-act-no-10149/",
        title: "RA 10149 - Public Service Act",
    ...
    items: [{ inspectionItemName: "LTFRB Franchise", order: 1 }],
  },
  {
    name: "LTO Accreditation Compliance",
    description: "LTO Accreditation validity checklist",
    notes:
      "Covers LTO accreditation requirements for driving schools and related businesses",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "LTO Accreditation", order: 1 }],
  },
  {
    ...
    items: [{ inspectionItemName: "LTO Vehicle Registration", order: 1 }],
  },
  {
    name: "Medical Device Retailer LTO Compliance",
    description:
      "Medical Device Retailer License to Operate validity checklist",
    ...
    items: [
      {
        inspectionItemName: "Medical Device Retailer License to Operate",
        order: 1,
      },
    ],
  },
  {
    ...
    notes:
      "Covers exploration permit requirements under RA 7942 for mineral exploration",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1995/03/03/republic-act-no-7942/",
        title: "RA 7942 - Philippine Mining Act of 1995",
    ...
    items: [{ inspectionItemName: "MGB Exploration Permit", order: 1 }],
  },
  {
    name: "MGB Mineral Agreement Compliance",
    description: "MGB Mineral Agreement validity checklist",
    notes:
      "Covers mineral agreement requirements under RA 7942 for mining operations",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1995/03/03/republic-act-no-7942/",
        title: "RA 7942 - Philippine Mining Act of 1995",
    ...
    items: [{ inspectionItemName: "MGB Mineral Agreement", order: 1 }],
  },
  {
    name: "MGB Permit Compliance",
    description: "MGB Permit validity checklist",
    notes:
      "Covers MGB permit requirements under RA 7942 for mining-related activities",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1995/03/03/republic-act-no-7942/",
        title: "RA 7942 - Philippine Mining Act of 1995",
    ...
    items: [{ inspectionItemName: "MGB Permit", order: 1 }],
  },
  {
    name: "NBDB Publisher Registration Compliance",
    description: "NBDB Publisher Registration validity checklist",
    notes:
      "Covers NBDB registration requirements under RA 10372 for book publishers",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "NBDB Publisher Registration", order: 1 }],
  },
  {
    name: "NFA Accreditation Compliance",
    description: "NFA Accreditation validity checklist",
    notes:
      "Covers NFA accreditation requirements for rice and grain businesses",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "NFA Accreditation", order: 1 }],
  },
  {
    ...
    items: [{ inspectionItemName: "NFA License", order: 1 }],
  },
  {
    ...
    items: [{ inspectionItemName: "NFA Registration", order: 1 }],
  },
  {
    ...
    items: [{ inspectionItemName: "NMIS Accreditation", order: 1 }],
  },
  {
    name: "NPC Registration Compliance",
    description: "NPC Registration validity checklist",
    notes:
      "Covers NPC registration requirements under RA 5207 for nuclear-related activities",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "NPC Registration", order: 1 }],
  },
  {
    name: "NTC CPCN Compliance",
    description:
      "NTC Certificate of Public Convenience and Necessity validity checklist",
    notes:
      "Covers NTC CPCN requirements under RA 10149 for telecommunications operations",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2015/07/21/republic-act-no-10149/",
        title: "RA 10149 - Public Service Act",
  ...
  },
  {
    ...
    notes:
      "Covers NTC certificate requirements for telecommunications equipment",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "NTC Certificate", order: 1 }],
  },
  {
    name: "NTC PA-CPCN Compliance",
    description: "NTC Provisional Authority CPCN validity checklist",
    notes:
      "Covers NTC PA-CPCN requirements under RA 10149 for provisional telecom operations",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2015/07/21/republic-act-no-10149/",
        title: "RA 10149 - Public Service Act",
    ...
    items: [{ inspectionItemName: "NTC Provisional Authority CPCN", order: 1 }],
  },
  {
    name: "NWRB CPC Compliance",
    description: "NWRB Certificate of Public Convenience validity checklist",
    notes:
      "Covers NWRB CPC requirements under RA 9275 for water utility operations",
    legalBasis: [
      {
    ...
    items: [
      {
        inspectionItemName: "NWRB Certificate of Public Convenience",
        order: 1,
      },
    ],
  },
  {
    ...
    notes:
      "Covers NWRB water permit requirements under RA 9275 for water extraction",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2004/06/23/republic-act-no-9275/",
        title: "RA 9275 - Water Code of the Philippines",
    ...
    items: [{ inspectionItemName: "NWRB Water Permit", order: 1 }],
  },
  // Batch 4: PCAB, PDEA, PEZA, Pharmacist, PhilHealth, PNP, PRC licenses, Quarry permits, School accreditation, SEC, Signage permits, Subdivision permits, TESDA, Weights & Measures
  {
    ...
    notes:
      "Covers PCAB license requirements under RA 10066 for construction contractors",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "PCAB License", order: 1 }],
  },
  {
    name: "PDEA S2 License Compliance",
    description: "PDEA S2 License validity checklist",
    notes:
      "Covers PDEA S2 license requirements under RA 9165 for controlled substances",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "PDEA S2 License", order: 1 }],
  },
  {
    name: "PEZA Registration Compliance",
    description: "PEZA Registration validity checklist",
    notes:
      "Covers PEZA registration requirements under RA 7916 for export-oriented businesses",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "PEZA Registration", order: 1 }],
  },
  {
    name: "Pharmacist in Charge Credential Compliance",
    description: "Pharmacist in Charge Credential validity checklist",
    notes:
      "Covers pharmacist credential requirements under RA 9711 for pharmacies",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2008/06/18/republic-act-no-9711/",
        title: "RA 9711 - FDA Act of 2008",
  ...
  },
  {
    ...
    notes:
      "Covers PhilHealth accreditation requirements under RA 11223 for health facilities",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2018/12/20/republic-act-no-11223/",
        title: "RA 11223 - Universal Health Care Act",
    ...
    items: [{ inspectionItemName: "PhilHealth Accreditation", order: 1 }],
  },
  {
    name: "PNP FEO License Compliance",
    description: "PNP FEO License validity checklist",
    notes:
      "Covers PNP FEO license requirements under RA 10591 for firearms businesses",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "PNP FEO License", order: 1 }],
  },
  {
    name: "PNP SOSIA License Compliance",
    description: "PNP SOSIA License validity checklist",
    notes:
      "Covers PNP SOSIA license requirements under RA 7483 for security agencies",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "PNP SOSIA License", order: 1 }],
  },
  {
    name: "PRC Electrical License Compliance",
    description: "PRC Electrical License validity checklist",
    notes:
      "Covers PRC electrical license requirements under RA 9292 for electrical practitioners",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "PRC Electrical License", order: 1 }],
  },
  {
    name: "PRC License Compliance",
    description: "PRC License validity checklist",
    notes:
      "Covers PRC license requirements under RA 11598 for regulated professions",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "PRC License", order: 1 }],
  },
  {
    name: "PRC Plumbing License Compliance",
    description: "PRC Plumbing License validity checklist",
    notes:
      "Covers PRC plumbing license requirements under RA 8551 for plumbing practitioners",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "PRC Plumbing License", order: 1 }],
  },
  {
    name: "PRC Broker License Compliance",
    description: "PRC Broker License validity checklist",
    notes:
      "Covers PRC broker license requirements under RA 9646 for real estate brokers",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2019/02/14/republic-act-no-9646/",
        title: "RA 9646 - Real Estate Service Act",
    ...
    items: [{ inspectionItemName: "PRC Broker License", order: 1 }],
  },
  {
    name: "Quarry Permit Compliance",
    description: "Quarry Permit validity checklist",
    notes:
      "Covers quarry permit requirements under RA 7942 for quarrying operations",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1995/03/03/republic-act-no-7942/",
        title: "RA 7942 - Philippine Mining Act of 1995",
    ...
    items: [{ inspectionItemName: "Quarry Permit", order: 1 }],
  },
  {
    name: "School Accreditation Compliance",
    description: "School Accreditation validity checklist",
    notes:
      "Covers school accreditation requirements under BP 232 for educational institutions",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1982/01/17/batas-pambansa-blng-232/",
        title: "BP 232 - Education Act of 1982",
    ...
    items: [{ inspectionItemName: "School Accreditation", order: 1 }],
  },
  {
    ...
    items: [
      {
        inspectionItemName: "SEC Certificate of Authority for Lending",
        order: 1,
      },
    ],
  },
  {
    ...
    notes:
      "Covers signage permit requirements under PD 1096 for business signage",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1977/08/18/presidential-decree-no-1096/",
        title: "PD 1096 - National Building Code",
    ...
    items: [{ inspectionItemName: "Signage Permit", order: 1 }],
  },
  {
    name: "Subdivision Development Permit Compliance",
    description: "Subdivision Development Permit validity checklist",
    notes:
      "Covers subdivision development permit requirements under RA 11201 for housing projects",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2020/08/28/republic-act-no-11201/",
        title: "RA 11201 - Real Estate Service Act",
    ...
    items: [{ inspectionItemName: "Subdivision Development Permit", order: 1 }],
  },
  {
    name: "Condominium Project Approval Compliance",
    description: "Condominium Project Approval validity checklist",
    notes:
      "Covers condominium project approval requirements under RA 11201 for condominium developments",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/2020/08/28/republic-act-no-11201/",
        title: "RA 11201 - Real Estate Service Act",
    ...
    items: [{ inspectionItemName: "Condominium Project Approval", order: 1 }],
  },
  {
    name: "TESDA Registration Compliance",
    description: "TESDA Registration validity checklist",
    notes:
      "Covers TESDA registration requirements under RA 11927 for technical vocational institutions",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "TESDA Registration", order: 1 }],
  },
  {
    name: "Weights and Measures Seal Compliance",
    description: "Weights and Measures Seal validity checklist",
    notes:
      "Covers weights and measures seal requirements under PD 939 for weighing scales",
    legalBasis: [
      {
    ...
    items: [{ inspectionItemName: "Weights and Measures Seal", order: 1 }],
  },
];
...
async function seedPostRequirementChecklists() {
  ...
  try {
    ...
    inspectionItems.forEach((item) =>
      inspectionItemMap.set(item.name, item._id),
    );
    ...
    for (const checklistData of POST_REQUIREMENT_CHECKLISTS) {
      ...
      for (const item of checklistData.items) {
        ...
        if (!inspectionItemId) {
          console.log(
            `Warning: No inspection item found with name: ${item.inspectionItemName}`,
          );
          continue;
        }
        itemsWithIds.push({
      ...
      if (itemsWithIds.length === 0) {
        console.log(
          `Warning: Skipping checklist ${checklistData.name} - no valid inspection items`,
        );
        continue;
      }

      const postRequirementCode =
        CHECKLIST_POST_REQUIREMENT_MAP[checklistData.name];
      const postRequirementId = postRequirementMap.get(postRequirementCode);

      if (!postRequirementId) {
        console.log(
          `Warning: No post requirement found with code: ${postRequirementCode}`,
        );
        continue;
      }
      ...
      await PostRequirement.findByIdAndUpdate(postRequirementId, {
        checklistId: checklist._id,
      });

      createdChecklists.push(checklist);
      console.log(
        `Created checklist: ${checklist.name} for post requirement: ${postRequirementCode}`,
      );
    }

    console.log(
      `Created ${createdChecklists.length} post requirement checklists`,
    );
