...
module.exports = {
  ...
  conditionalFees: [
    ...
    // MINING EQUIPMENT FEES
    {
      ...
      question: "Does your business require safety equipment for mining operations?",
      amount: 5000,
      category: "MIN",
      isActive: true,
    },
    ...
    // PHARMACY-SPECIFIC FEES
    {
      ...
      notes: "Fee for temperature-controlled pharmaceutical storage required by FDA",
      question: "Does your pharmacy store temperature-sensitive medicines requiring cold storage?",
      amount: 2000,
      category: "RET",
      isActive: true,
    },
    {
      ...
      notes: "Fee for pharmacies handling regulated/controlled drugs requiring additional FDA oversight",
    ...
    },
    {
      _id: 'e-pharmacy',
      name: "E-Pharmacy Fee",
      notes: "Fee for online pharmacy operations requiring additional FDA licensing",
      question: "Does your pharmacy operate online or offer e-pharmacy services?",
      amount: 3000,
      category: "RET",
      isActive: true,
    },
  ...
  variableFeeRules: [
    // ENTERTAINMENT FEES
    {
      ...
      description: "Variable fee for salon and barbershop businesses based on the number of service chairs or stations",
      notes: "Fee for salon/barbershop based on number of chairs/stations",
      question: "How many barber chairs or salon stations does your business have?",
      ...
      legalBasis: [{
        ...
        description: 'An ordinance imposing fees and charges on salon and barbershop operations based on business capacity'
      }],
      isActive: true,
    },
    ...
    // FACILITY-BASED VARIABLE FEES (Bracketed by sqm)
    {
      ...
      description: "Variable fee for businesses with parking facilities based on total parking area in square meters",
      ...
      legalBasis: [{
        ...
        description: 'Authority of LGUs to impose reasonable fees for parking space usage and maintenance'
      }],
      isActive: true,
    },
    {
      ...
      description: "Variable fee for businesses with warehouse or storage facilities based on floor area",
      ...
      legalBasis: [{
        ...
        description: 'Regulation on warehouse and storage facility fees based on floor area'
      }],
      isActive: true,
    },
    ...
    // BUILDING/CONSTRUCTION VARIABLES
    {
      ...
      description: "Variable for boarding houses and dormitories based on the number of boarders or lodgers accommodated",
      notes: "Variable for boarding houses/dormitories based on number of boarders",
      question: "How many boarders/lodgers does your boarding house or dormitory accommodate?",
      calculationMethod: 'bracketed',
      unit: 'boarder',
      ...
      legalBasis: [{
        ...
        description: 'Regulation of boarding houses and dormitories including capacity-based fees'
      }],
      isActive: true,
    },
    ...
    // TRANSPORTATION FEES
    {
      ...
      description: "Variable fee for public utility vehicle operators based on the number of vehicles (bus, jeepney, taxi)",
      notes: "Fee for PUVs (bus, jeepney, taxi) per unit based on vehicle type",
      question: "How many public utility vehicles (bus, jeepney, taxi) does your business operate?",
      ...
      legalBasis: [{
        ...
        description: 'Standard fees for public utility vehicle registration and operation'
      }],
      isActive: true,
    },
    {
      ...
      description: "Variable fee for trucking and logistics businesses based on the number of trucks or hauling vehicles",
      notes: "Mayor's permit fee for trucking operations",
      question: "How many trucks or hauling vehicles does your business operate?",
      calculationMethod: 'per_unit',
      baseRate: 400,
      unit: 'truck',
      unitSingular: 'truck',
      ...
      legalBasis: [{
        ...
        description: 'Fees for trucking and logistics operations within municipal jurisdiction'
      }],
      isActive: true,
    },
    ...
    // MINING FEES
    {
      ...
      description: "Variable fee for mining operations based on the total mining area in hectares",
      ...
      legalBasis: [{
        ...
        description: 'Guidelines for the collection of fees from mining permit holders'
      }],
      isActive: true,
    },
    ...
    // REAL ESTATE FEES
    {
      ...
      description: "Variable fee for subdivision developers based on the number of saleable lots in the project",
      ...
      legalBasis: [{
        ...
        description: 'Standard fees for subdivision development and lot registration'
      }],
      isActive: true,
    },
    {
      ...
      description: "Variable fee for subdivision developers based on the total subdivision area in hectares",
      ...
      legalBasis: [{
        title: 'PD 957 - The Subdivision and Condominium Buyer\'s Protective Decree',
        description: 'Regulatory framework for subdivision development including area-based fees'
      }],
      isActive: true,
    },
    {
      ...
      description: "Variable fee for subdivision developers based on the total housing component floor area in square meters",
      notes: "Fee for subdivision developers based on housing component floor area",
      question: "What is the total housing component floor area in square meters?",
      calculationMethod: 'per_unit',
      baseRate: 14.40,
      unit: 'sqm',
      unitSingular: 'sqm',
      ...
      legalBasis: [{
        ...
        description: 'Fees based on total floor area for residential development projects'
      }],
      isActive: true,
    },
    ...
    // HEALTH FEES
    {
      ...
      description: "Variable sanitary fee for hospitals and healthcare facilities based on bed capacity",
      ...
      legalBasis: [{
        ...
        description: 'Sanitary inspection fees for healthcare facilities based on bed capacity'
      }],
      isActive: true,
    },
    ...
    // MANUFACTURING FEES
    {
      ...
      description: "Variable fee for printing press businesses based on the number of printing machines (photostatic, xerox, recopying, etc.)",
      notes: "Fee for printing press based on number of machines",
      question: "How many printing machines does your business have (photostatic, xerox, recopying, etc.)?",
      calculationMethod: 'per_unit',
      baseRate: 500,
      unit: 'machine',
      ...
      legalBasis: [{
        ...
        description: 'Business permit fees for printing and publishing establishments'
      }],
      isActive: true,
    },
    ...
    // RETAIL FEES
    {
      ...
      description: "Variable fee for market stall operators based on stall floor area in square meters",
      ...
      legalBasis: [{
        ...
        description: 'Market stall rental fees based on floor area classification'
      }],
      isActive: true,
    },
    ...
    // REAL ESTATE FEES
    {
      _id: 'hotel-room-fee',
      name: "Hotel Room Fee",
      description: "Variable fee for hotels and accommodation establishments based on the number of rooms",
      ...
      legalBasis: [{
        ...
        description: 'Accommodation establishment fees based on room capacity classification'
      }],
      isActive: true,
    },
    {
      ...
      name: "Apartment Unit",
      description: "Variable for apartment rental businesses based on the number of rental units",
    ...
    // FINANCIAL INSTITUTION VARIABLES (Classification-based)
    {
      ...
      description: "Variable for banks based on bank type classification (Rural/Thrift, Commercial/Industrial, Universal)",
      ...
      classifications: [
        { name: 'Rural, Thrift and Savings Bank', fee: 2000, description: 'Rural, thrift, and savings banks' },
        { name: 'Commercial, Industrial and Development Bank', fee: 3000, description: 'Commercial, industrial, and development banks' },
        { name: 'Universal Bank', fee: 5000, description: 'Universal banks' },
      ],
      legalBasis: [{
        title: 'BSP Circular No. 898',
        description: 'Classification and registration of banks and financial institutions'
      }],
      isActive: true,
    },
    {
      ...
      description: "Variable fee for lending institutions based on type (Lending Investor, Money Shop, Investment Company)",
      ...
      classifications: [
        { name: 'Lending Investor', fee: 2000, description: 'Lending investor companies' },
        { name: 'Money Shop', fee: 3000, description: 'Money shop/pawning services' },
        { name: 'Investment Company', fee: 5000, description: 'Investment and financing companies' },
      ],
      legalBasis: [{
        title: 'BSP Circular No. 898',
        description: 'Classification and registration of banks and financial institutions'
    ...
    },
    {
      ...
      description: "Variable fee for pawnshops based on type (Single-Branch, Multi-Branch, Franchise)",
      ...
      classifications: [
        { name: 'Single-Branch Pawnshop', fee: 2000, description: 'Single-branch pawnshop operations' },
        { name: 'Multi-Branch Pawnshop', fee: 3000, description: 'Multi-branch pawnshop operations' },
        { name: 'Pawnshop Franchise', fee: 5000, description: 'Pawnshop franchise operations' },
      ],
      legalBasis: [{
        title: 'BSP Circular No. 898',
        description: 'Classification and registration of banks and financial institutions'
      ...
      capitalizationBrackets: [
        {
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱673 for micro enterprises with capitalization up to ₱150,000',
        },
        {
          _id: 'rtl-cap-2',
          name: 'Cottage',
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱2,000 for cottage enterprises with capitalization ₱150,001 - ₱1,500,000',
        },
        {
          _id: 'rtl-cap-3',
          name: 'Small',
      ...
      capitalizationBrackets: [
        {
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱673 for micro food establishments with capitalization up to ₱150,000',
        },
        {
          _id: 'fds-cap-2',
          name: 'Cottage',
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱2,000 for cottage food establishments with capitalization ₱150,001 - ₱1,500,000',
        },
        {
          _id: 'fds-cap-3',
          name: 'Small',
      ...
      capitalizationBrackets: [
        {
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱500 for micro manufacturers with capitalization up to ₱150,000',
        },
        {
          _id: 'mfg-2',
          name: 'Cottage',
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱1,500 for cottage manufacturers with capitalization ₱150,001 - ₱1,500,000',
        },
        {
          _id: 'mfg-3',
          name: 'Small',
      ...
      capitalizationBrackets: [
        {
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱673 for micro service providers with capitalization up to ₱150,000',
        },
        {
          _id: 'svc-cap-2',
          name: 'Cottage',
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱2,000 for cottage service providers with capitalization ₱150,001 - ₱1,500,000',
        },
        {
          _id: 'svc-cap-3',
          name: 'Small',
      ...
      capitalizationBrackets: [
        {
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱1,000 for micro financial institutions with capitalization up to ₱150,000',
        },
        {
          _id: 'fin-cap-2',
          name: 'Cottage',
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱3,000 for cottage financial institutions with capitalization ₱150,001 - ₱1,500,000',
        },
        {
          _id: 'fin-cap-3',
          name: 'Small',
      ...
      capitalizationBrackets: [
        {
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱673 for micro real estate businesses with capitalization up to ₱150,000',
        },
        {
          _id: 'res-cap-2',
          name: 'Cottage',
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱2,000 for cottage real estate businesses with capitalization ₱150,001 - ₱1,500,000',
        },
        {
          _id: 'res-cap-3',
          name: 'Small',
      ...
      capitalizationBrackets: [
        {
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱673 for micro transportation businesses with capitalization up to ₱150,000',
        },
        {
          _id: 'trn-cap-2',
          name: 'Cottage',
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱2,000 for cottage transportation businesses with capitalization ₱150,001 - ₱1,500,000',
        },
        {
          _id: 'trn-cap-3',
          name: 'Small',
      ...
      capitalizationBrackets: [
        {
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱500 for micro agricultural businesses with capitalization up to ₱150,000',
        },
        {
          _id: 'agr-cap-2',
          name: 'Cottage',
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱1,500 for cottage agricultural businesses with capitalization ₱150,001 - ₱1,500,000',
        },
        {
          _id: 'agr-cap-3',
          name: 'Small',
      ...
      capitalizationBrackets: [
        {
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱500 for micro construction businesses with capitalization up to ₱150,000',
        },
        {
          _id: 'con-cap-2',
          name: 'Cottage',
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱1,500 for cottage construction businesses with capitalization ₱150,001 - ₱1,500,000',
        },
        {
          _id: 'con-cap-3',
          name: 'Small',
      ...
      capitalizationBrackets: [
        {
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱500 for micro mining operations with capitalization up to ₱150,000',
        },
        {
          _id: 'min-cap-2',
          name: 'Cottage',
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱1,500 for cottage mining operations with capitalization ₱150,001 - ₱1,500,000',
        },
        {
          _id: 'min-cap-3',
          name: 'Small',
      ...
      capitalizationBrackets: [
        {
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱673 for micro utility providers with capitalization up to ₱150,000',
        },
        {
          _id: 'utl-cap-2',
          name: 'Cottage',
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱2,000 for cottage utility providers with capitalization ₱150,001 - ₱1,500,000',
        },
        {
          _id: 'utl-cap-3',
          name: 'Small',
      ...
      capitalizationBrackets: [
        {
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱673 for micro wholesale businesses with capitalization up to ₱150,000',
        },
        {
          _id: 'wsl-cap-2',
          name: 'Cottage',
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱2,000 for cottage wholesale businesses with capitalization ₱150,001 - ₱1,500,000',
        },
        {
          _id: 'wsl-cap-3',
          name: 'Small',
      ...
      capitalizationBrackets: [
        {
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱673 for micro entertainment businesses with capitalization up to ₱150,000',
        },
        {
          _id: 'ent-cap-2',
          name: 'Cottage',
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱2,000 for cottage entertainment businesses with capitalization ₱150,001 - ₱1,500,000',
        },
        {
          _id: 'ent-cap-3',
          name: 'Small',
      ...
      capitalizationBrackets: [
        {
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱500 for micro educational institutions with capitalization up to ₱150,000',
        },
        {
          _id: 'edu-cap-2',
          name: 'Cottage',
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱1,500 for cottage educational institutions with capitalization ₱150,001 - ₱1,500,000',
        },
        {
          _id: 'edu-cap-3',
          name: 'Small',
      ...
      capitalizationBrackets: [
        {
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱500 for micro warehouse/logistics businesses with capitalization up to ₱150,000',
        },
        {
          _id: 'whl-cap-2',
          name: 'Cottage',
          ...
          excessRate: null,
          excessRateType: null,
          notes: 'Fixed ₱1,500 for cottage warehouse/logistics businesses with capitalization ₱150,001 - ₱1,500,000',
        },
        {
          _id: 'whl-cap-3',
          name: 'Small',
