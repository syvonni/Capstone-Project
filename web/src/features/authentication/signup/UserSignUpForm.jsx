...
export default function UserSignUpForm({ extraContent }) {
  ...
  const { step, emailForVerify, devCodeForVerify, verifyEmail, handleVerificationSubmit } =
    useUserSignUpFlow();
  ...
  const { handleFillDemoData, handleFillInvalidData } = useDemoDataPrefill(
    form,
    setPasswordValue,
    handlePreviousStep
  );
  ...
  return (
    <div style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      {extraContent && (
        <div
          style={{ display: 'flex', justifyContent: 'center', marginBottom: isMobile ? 20 : 24 }}
        >
          {extraContent}
        </div>
      )}
      <Form
        ...
        onFinish={async (values) => {
          ...
          if (maintenance.active) {
            message.warning(
              'Registration is temporarily unavailable due to maintenance. Please try again later.'
            );
            return;
          }
      ...
      >
        ...
        <div style={{ display: currentStep === 0 ? 'block' : 'none' }}>
          ...
          <Form.Item
            ...
            label={
              <span>
                Confirm Password<span style={{ color: token.colorError, marginLeft: 4 }}>*</span>
              </span>
            }
          ...
          >
            <Checkbox style={{ fontSize: isMobile ? 13 : undefined }}>
              ...
              <Link to="/terms" style={{ color: token.colorPrimary, textDecoration: 'underline' }}>
                Terms of Service
              </Link>{' '}
              and{' '}
              <Link
        ...
        <div style={{ display: currentStep === 1 ? 'block' : 'none' }}>
          ...
          >
            ...
            >
              We use your details only to create and protect your account, verify your identity, and
              process permit-related requests in this system.
            </Text>
            <Text
              style={{
                display: 'block',
            ...
            >
              For full details on handling and protection of your data, please see our{' '}
              <Link
                to="/privacy"
                style={{ color: token.colorPrimary, textDecoration: 'underline' }}
              >
