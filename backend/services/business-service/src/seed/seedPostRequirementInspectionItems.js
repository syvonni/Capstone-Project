...
const POST_REQUIREMENT_INSPECTION_ITEMS = [
  // Batch 1: AMLC, Animal Welfare, ATH, BAI, BFAR, BIR ATP, BOI, BPI, BSP
  {
    ...
    question:
      "Is the business registered with the Anti-Money Laundering Council?",
    notes:
      "Check for AMLC registration certificate or confirmation letter. Required for covered persons under RA 9160.",
  ...
  },
  {
    ...
    notes:
      "Check the registration date and renewal status. AMLC registration must be maintained while operating as a covered person.",
  ...
  },
  {
    ...
    question:
      "Does the business have a valid Animal Welfare Seminar certificate?",
    notes:
      "Check for certificate of attendance from BAI/DA-RFOs or BAI-recognized organization. Required for animal handlers.",
  ...
  },
  {
    ...
    question:
      "Does the business have valid Authorization to Haul from DENR/MGB?",
    notes:
      "Check for authorization document for hauling mineral products. Required under RA 7942.",
  ...
  },
  {
    ...
    notes:
      "Check the authorization validity period. Must be renewed as per DENR/MGB regulations.",
  ...
  },
  {
    ...
    notes:
      "Check for BAI registration certificate. Required for veterinary clinics, hospitals, and animal facilities.",
  ...
  },
  {
    ...
    question:
      "Is the business registered with the Bureau of Fisheries and Aquatic Resources?",
    notes:
      "Check for BFAR registration certificate. Required for fisheries-related businesses.",
  ...
  },
  {
    ...
    notes:
      "Check for ATP document. Required for commercial printing of official receipts, sales invoices, and other accountable forms.",
  ...
  },
  {
    ...
    notes:
      "Check for BOI registration certificate. Required for export-oriented or priority projects for tax incentives.",
  ...
  },
  {
    ...
    notes:
      "Check for BPI accreditation certificate. Required for plant nursery operators.",
  ...
  },
  {
    ...
    notes:
      "Check for BPI license. Required for certain plant-related operations.",
  ...
  },
  {
    ...
    question:
      "Does the business have valid authority from BSP for pawnshop operations?",
    notes:
      "Check for BSP authority certificate. Required for pawnshop operations.",
  ...
  },
  {
    ...
    notes:
      "Check for BSP Certificate of Authority. Required for certain financial operations.",
  ...
  // Batch 2: CAAP, CNC, CHED, Congressional Franchise, Demolition Permit, DENR permits, DepEd permits, DHSUD permits, DICT, DMW, DOE, DOH permits, DOLE, DOT, DSWD, DTI permits, E-pharmacy
  {
    ...
    notes:
      "Check for height clearance document from CAAP. Required for structures near airports.",
  ...
  },
  {
    ...
    notes:
      "Check for RPAS operator certificate. Required for drone operations.",
  ...
  },
  {
    ...
    notes:
      "Check for CNC from DENR-EMB. Required for projects not requiring ECC.",
  ...
  },
  {
    ...
    notes:
      "Check for CHED recognition document. Required for higher education institutions.",
  ...
  },
  {
    ...
    notes:
      "Check for congressional franchise document. Required for public utilities.",
  ...
  },
  {
    ...
    notes:
      "Check for demolition permit from local government. Required before demolition work.",
  ...
  },
  {
    ...
    question:
      "Does the business have valid DENR Permit to Operate Air Installation?",
  ...
  },
  {
    ...
    notes:
      "Check for wastewater discharge permit. Required for facilities discharging wastewater.",
  ...
  },
  {
    ...
    notes:
      "Check for wood processing permit. Required for wood-based industries.",
  ...
  },
  {
    ...
    notes:
      "Check for PEMEDES authority. Required for medical device establishments.",
  ...
  },
  {
    ...
    notes:
      "Check for permit to construct. Required for health facility construction.",
  ...
  },
  {
    ...
    question:
      "Does the business have valid DTI Freight Forwarding Accreditation?",
    notes:
      "Check for freight forwarding accreditation. Required for logistics companies.",
  ...
  },
  {
    name: "ERC CPCN",
    question:
      "Does the business have valid ERC Certificate of Public Convenience and Necessity?",
  ...
  },
  {
    ...
    notes:
      "Check for FPA license. Required for commercial pesticide applicators.",
  ...
  },
  {
    ...
    notes:
      "Check for FPA LTO. Required for fertilizer and pesticide businesses.",
  ...
  },
  {
    ...
    notes:
      "Check for liquor license. Required for establishments serving alcoholic beverages.",
  ...
  },
  {
    ...
    notes:
      "Check for LLDA discharge permit. Required for facilities discharging into Laguna Lake.",
  ...
  },
  {
    ...
    question:
      "Does the business have valid LTFRB Certificate of Public Convenience?",
    notes:
      "Check for LTFRB CPC. Required for public transportation operations.",
  ...
  },
  {
    ...
    notes:
      "Check for LTFRB franchise. Required for public utility vehicle operations.",
  ...
  },
  {
    ...
    notes:
      "Check for LTO accreditation. Required for driving schools and related businesses.",
  ...
  },
  {
    ...
    question:
      "Does the business have valid Medical Device Retailer License to Operate?",
    notes:
      "Check for medical device retailer LTO. Required for selling medical devices.",
  ...
  },
  {
    ...
    notes:
      "Check for exploration permit. Required for mineral exploration activities.",
  ...
  },
  {
    ...
    notes:
      "Check for NFA accreditation. Required for rice and grain businesses.",
  ...
  },
  {
    ...
    notes:
      "Check for NFA registration. Required for rice and grain businesses.",
  ...
  },
  {
    ...
    notes:
      "Check for NPC registration. Required for nuclear-related activities.",
  ...
  },
  {
    ...
    question:
      "Does the business have valid NTC Certificate of Public Convenience and Necessity?",
  ...
  },
  {
    ...
    notes:
      "Check for NTC certificate. Required for telecommunications equipment.",
  ...
  },
  {
    ...
    notes:
      "Check for NTC PA-CPCN. Required for provisional telecommunications operations.",
  ...
  },
  {
    ...
    question:
      "Does the business have valid NWRB Certificate of Public Convenience?",
  ...
  },
  {
    ...
    notes:
      "Check for NWRB water permit. Required for water extraction and use.",
  ...
  },
  {
    ...
    notes:
      "Check for PDEA S2 license. Required for handling controlled substances.",
  ...
  },
  {
    ...
    notes:
      "Check for PEZA registration. Required for export-oriented businesses.",
  ...
  },
  {
    ...
    notes:
      "Check for PhilHealth accreditation. Required for health facilities.",
  ...
  },
  {
    ...
    notes:
      "Check for PNP FEO license. Required for firearms and explosives businesses.",
  ...
  },
  {
    ...
    notes:
      "Check for PRC electrical license. Required for electrical practitioners.",
  ...
  },
  {
    ...
    notes:
      "Check for PRC plumbing license. Required for plumbing practitioners.",
  ...
  },
  {
    ...
    notes:
      "Check for school accreditation. Required for educational institutions.",
  ...
  },
  {
    ...
    question:
      "Does the business have valid SEC Certificate of Authority for Lending?",
  ...
  },
  {
    ...
    notes:
      "Check for subdivision development permit. Required for housing projects.",
  ...
  },
  {
    ...
    notes:
      "Check for condominium project approval. Required for condominium developments.",
  ...
  },
  {
    ...
    notes:
      "Check for TESDA registration. Required for technical vocational institutions.",
...
async function seedPostRequirementInspectionItems() {
  ...
  try {
    ...
    console.log(
      `Created ${createdItems.length} post requirement inspection items`,
    );
    console.log(
      `Updated ${updatedItems.length} post requirement inspection items`,
    );
...
module.exports = {
  ...
  POST_REQUIREMENT_INSPECTION_ITEMS,
};
