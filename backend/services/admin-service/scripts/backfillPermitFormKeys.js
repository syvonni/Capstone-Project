...
if (args.includes("--help") || args.includes("-h")) {
  console.log("Usage:");
  console.log(
    "  node scripts/backfillPermitFormKeys.js --dry-run  # Preview changes (default)",
  );
  console.log(
    "  node scripts/backfillPermitFormKeys.js --apply    # Apply changes",
  );
  console.log(
    "  node scripts/backfillPermitFormKeys.js --help     # Show this help",
  );
  process.exit(0);
}
