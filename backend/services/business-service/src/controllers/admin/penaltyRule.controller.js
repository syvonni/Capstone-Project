...
const penaltyRuleService = require("../../services/admin/penaltyRule.service");

class PenaltyRuleController extends BaseController {
  constructor() {
    super();
    this.service = penaltyRuleService;
  }
...
module.exports = new PenaltyRuleController();
