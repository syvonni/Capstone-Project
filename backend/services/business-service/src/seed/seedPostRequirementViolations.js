...
const POST_REQUIREMENT_VIOLATIONS = [
  // Batch 1: AMLC, Animal Welfare, ATH, BAI, BFAR, BIR ATP, BOI, BPI, BSP
  {
    ...
    description: 'Business is not registered with the Anti-Money Laundering Council',
    notes: 'AMLC registration is required for covered persons under RA 9160. Check for registration certificate.',
    penaltyAmount: 50000,
    severity: 'critical',
    legalBasis: [
      {
  ...
  },
  {
    ...
    notes: 'AMLC registration must be maintained while operating as a covered person. Check renewal status.',
    penaltyAmount: 25000,
    severity: 'major',
    legalBasis: [
      {
  ...
  },
  {
    ...
    description: 'Business does not have valid Animal Welfare Seminar certificate',
    notes: 'Certificate of attendance from BAI/DA-RFOs or BAI-recognized organization is required for animal handlers.',
    penaltyAmount: 5000,
    severity: 'minor',
    legalBasis: [
      {
  ...
  },
  {
    ...
    description: 'Business does not have valid Authorization to Haul from DENR/MGB',
    notes: 'Authorization to Haul is required for transporting mineral products under RA 7942.',
    penaltyAmount: 20000,
    severity: 'major',
    legalBasis: [
      {
  ...
  },
  {
    ...
    notes: 'Authorization to Haul must be valid and current. Check validity period.',
    penaltyAmount: 10000,
    severity: 'minor',
    legalBasis: [
      {
  ...
  },
  {
    ...
    description: 'Business is not registered with the Bureau of Animal Industry',
    notes: 'BAI registration is required for veterinary clinics, hospitals, and animal facilities.',
    penaltyAmount: 10000,
    severity: 'major',
    legalBasis: [
      {
  ...
  },
  {
    ...
    description: 'Business is not registered with the Bureau of Fisheries and Aquatic Resources',
  ...
  },
  {
    ...
    notes: 'ATP is required for commercial printing of official receipts, sales invoices, and other accountable forms.',
    penaltyAmount: 10000,
    severity: 'major',
    legalBasis: [
      {
  ...
  },
  {
    ...
    notes: 'BOI registration is required for export-oriented or priority projects for tax incentives.',
    penaltyAmount: 15000,
    severity: 'major',
    legalBasis: [
      {
  ...
  },
  {
    ...
    description: 'Business does not have valid authority from BSP for pawnshop operations',
  ...
  },
  {
    ...
    description: 'Business does not have valid Certificate of Authority from BSP',
    notes: 'BSP Certificate of Authority is required for certain financial operations.',
    penaltyAmount: 20000,
    severity: 'critical',
    legalBasis: [
      {
  ...
  },
  {
    ...
    notes: 'Congressional franchise required for public utilities and certain businesses.',
  ...
  },
  {
    ...
    description: 'Business does not have valid DENR Certificate of Non-Coverage',
  ...
  },
  {
    ...
    description: 'Business does not have valid DENR Permit to Operate Air Installation',
  ...
  },
  {
    ...
    description: 'Business does not have valid DENR Pollution Management Program Implementation Notice',
  ...
  },
  {
    ...
    description: 'Business does not have valid DENR Wastewater Discharge Permit',
    notes: 'Wastewater discharge permit required for facilities discharging wastewater.',
    penaltyAmount: 50000,
    severity: 'critical',
    legalBasis: [
      {
  ...
  },
  {
    ...
    description: 'Business does not have valid DTI Freight Forwarding Accreditation',
  ...
  },
  {
    ...
    description: 'Business does not have valid ERC Certificate of Public Convenience and Necessity',
  ...
  },
  {
    ...
    description: 'Business does not have valid FPA Commercial Applicator License',
  ...
  },
  {
    ...
    notes: 'Liquor license required for establishments serving alcoholic beverages.',
    penaltyAmount: 25000,
    severity: 'major',
    legalBasis: [
      {
  ...
  },
  {
    ...
    notes: 'LLDA discharge permit required for facilities discharging into Laguna Lake.',
    penaltyAmount: 40000,
    severity: 'major',
    legalBasis: [
      {
  ...
  },
  {
    ...
    description: 'Business does not have valid LTFRB Certificate of Public Convenience',
  ...
  },
  {
    ...
    notes: 'LTO accreditation required for driving schools and related businesses.',
    penaltyAmount: 30000,
    severity: 'major',
    legalBasis: [
      {
  ...
  },
  {
    ...
    description: 'Business does not have valid Medical Device Retailer License to Operate',
  ...
  },
  {
    ...
    description: 'Business does not have valid NTC Certificate of Public Convenience and Necessity',
  ...
  },
  {
    ...
    description: 'Business does not have valid NWRB Certificate of Public Convenience',
  ...
  },
  {
    ...
    description: 'Business does not have valid SEC Certificate of Authority for Lending',
  ...
  },
  {
    ...
    notes: 'Condominium project approval required for condominium developments.',
    penaltyAmount: 75000,
    severity: 'critical',
    legalBasis: [
      {
...
async function seedPostRequirementViolations() {
  ...
  try {
    ...
    console.log(`Created ${createdViolations.length} post requirement violations and ${createdFees.length} penalty fees`);

    // Only disconnect if we connected
    if (didConnect) {
      await mongoose.disconnect();
    }
    return { createdCount: createdViolations.length, feesCreated: createdFees.length };
  } catch (err) {
