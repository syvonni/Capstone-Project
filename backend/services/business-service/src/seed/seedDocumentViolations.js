...
const DOCUMENT_VIOLATIONS = [
  // Fire Safety Inspection Certificate Violations
  {
    ...
    correctiveAction: 'Obtain valid Fire Safety Inspection Certificate from BFP'
  },
  {
  ...
  },
  {
    ...
    notes: 'Certificate lacks proper BFP signature, seal, or certificate number.',
    penaltyAmount: 2000,
    severity: 'major',
    legalBasis: [
      {
  ...
  },
  {
    ...
    notes: 'Permit lacks proper health office signature, seal, or permit number.',
    penaltyAmount: 2000,
    severity: 'major',
    legalBasis: [
      {
  ...
  },
  {
    ...
    notes: 'Clearance lacks proper zoning office signature, seal, or clearance number.',
    penaltyAmount: 2000,
    severity: 'major',
    legalBasis: [
      {
