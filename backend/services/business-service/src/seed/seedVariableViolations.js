...
const VARIABLE_VIOLATIONS = [
  // Salon/Barber Chair Fee Violations
  {
    ...
    description:
      "Business declared incorrect number of barber chairs or salon stations",
    notes:
      "Declared chair/station count does not match actual count. Verify all service areas.",
    penaltyAmount: 2000,
    severity: "major",
    legalBasis: [
      {
        ...
        description:
          "Section 152: Truthful declaration requirements for fee assessment",
      },
    ],
    correctiveAction:
      "Update declaration to reflect actual chair/station count",
  },
  {
    ...
    notes:
      "No business permit application forms, floor plans, or other documentation showing chair/station count.",
    penaltyAmount: 1000,
    severity: "minor",
    legalBasis: [
      {
  ...
  },
  {
    ...
    description:
      "Parking space does not meet accessibility or marking standards",
    notes:
      "Parking spaces are not accessible, properly marked, or do not comply with accessibility standards.",
    penaltyAmount: 5000,
    severity: "major",
    legalBasis: [
      {
  ...
  // Storage Area Fee Violations
  {
    ...
    description:
      "Business declared incorrect warehouse/storage area in square meters",
  ...
  },
  {
    ...
    notes:
      "Storage areas lack fire safety, structural integrity, or proper ventilation.",
    penaltyAmount: 10000,
    severity: "critical",
    legalBasis: [
      {
  ...
  },
  {
    ...
    description:
      "Boarding house/dormitory does not comply with safety and occupancy standards",
    notes:
      "Lacks fire safety, emergency exits, or exceeds occupancy limits per room.",
    penaltyAmount: 15000,
    severity: "critical",
    legalBasis: [
      {
  ...
  },
  {
    ...
    notes:
      "One or more PUVs lack valid LTFRB franchise documents or registration.",
    penaltyAmount: 5000,
    severity: "major",
    legalBasis: [
      {
  ...
  // Trucking Unit Fee Violations
  {
    ...
    correctiveAction:
      "Update declaration to reflect actual trucking vehicle count",
  },
  {
    ...
    notes:
      "One or more trucking vehicles lack valid LTO registration or required permits.",
    penaltyAmount: 3000,
    severity: "major",
    legalBasis: [
      {
  ...
  },
  {
    ...
    notes:
      "One or more printing machines lack required registrations or permits.",
    penaltyAmount: 3000,
    severity: "major",
    legalBasis: [
      {
  ...
  // Parking Available (Yes/No) Violations
  {
    ...
    notes:
      "Declared having parking space but none exists or does not meet requirements.",
    penaltyAmount: 2000,
    severity: "minor",
    legalBasis: [
      {
    ...
    correctiveAction:
      "Update declaration to reflect actual parking space status",
  },
];
