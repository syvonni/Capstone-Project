...
export default function PermitFormAuditDetailPanel({ audit }) {
  if (!audit) {
    return (
  ...
  return (
    <div style={{ padding: 16 }}>
      <Descriptions column={1} size="small" bordered>
        ...
        {/* Permit Form Information */}
        {metadata.formId && <Descriptions.Item label="Form ID">{metadata.formId}</Descriptions.Item>}
