...
import { TemporaryPermitListPanel, FormDetailPanel, TemporaryPermitStatsPanel } from '../components'
  ...
  return (
    <>
      <ResponsiveSplitLayout
        ...
        listContent={<TemporaryPermitListPanel onSelect={handleFormSelect} selectedId={selectedFormId} onAddTemporaryPermit={handleAddTemporaryPermit} enableStats={true} statsActive={showStats} onStatsToggle={handleStatsToggle} />}
        detailContent={
          selectedFormId ? (
