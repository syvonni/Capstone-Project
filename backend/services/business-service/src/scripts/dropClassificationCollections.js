...
async function dropCollections() {
  try {
    ...
    const classificationFeesExists = await mongoose.connection.db.listCollections({ name: 'classificationfees' }).toArray();
    ...
    const classificationsExists = await mongoose.connection.db.listCollections({ name: 'classifications' }).toArray();
