...
const VARIABLE_CHECKLISTS = [
  // Salon/Barber Chair Fee
  {
    ...
    description:
      "Checklist for verifying salon and barbershop chair count and documentation",
    notes:
      "Covers chair count verification and documentation requirements for salon/barbershop businesses",
    legalBasis: [
      {
  ...
  // Parking Space Fee
  {
    ...
    notes:
      "Covers parking area measurement verification and accessibility compliance",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1991/10/10/republic-act-no-7160/",
        title: "Local Government Code of 1991",
    ...
    items: [
      ...
      {
        inspectionItemCustomId: "var-inspection-parking-accessibility",
        order: 2,
      },
    ],
  },
  ...
  // Boarding Capacity Fee
  {
    ...
    notes:
      "Covers boarding capacity verification and safety/occupancy standards",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1991/10/10/republic-act-no-7160/",
        title: "Local Government Code of 1991",
  ...
  // Trucking Unit Fee
  {
    ...
    notes:
      "Covers trucking vehicle count verification and registration validity",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1991/10/10/republic-act-no-7160/",
        title: "Local Government Code of 1991",
    ...
    items: [
      ...
      {
        inspectionItemCustomId: "var-inspection-trucking-registration",
        order: 2,
      },
    ],
  },
  ...
  // Subdivision Lot Fee
  {
    ...
    notes:
      "Covers subdivision lot count verification and development permit validity",
    legalBasis: [
      {
  ...
  // Subdivision Floor Area Fee
  {
    ...
    items: [
      {
        inspectionItemCustomId: "var-inspection-subdivision-floor-area",
        order: 1,
      },
    ],
  },
  ...
  // Printing Machine Fee
  {
    ...
    description:
      "Checklist for verifying printing machine count and registration",
    notes:
      "Covers printing machine count verification and registration requirements",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1991/10/10/republic-act-no-7160/",
        title: "Local Government Code of 1991",
    ...
    items: [
      ...
      {
        inspectionItemCustomId: "var-inspection-printing-registration",
        order: 2,
      },
    ],
  },
  ...
  // Market Stall Fee
  {
    ...
    items: [
      ...
      {
        inspectionItemCustomId: "var-inspection-market-stall-assignment",
        order: 2,
      },
    ],
  },
  ...
  // Hotel Room Fee
  {
    ...
    notes:
      "Covers hotel room count verification and DOT accreditation validity",
    legalBasis: [
      {
    ...
    items: [
      ...
      {
        inspectionItemCustomId: "var-inspection-hotel-accreditation",
        order: 2,
      },
    ],
  },
  ...
  // Apartment Unit Fee
  {
    ...
    notes:
      "Covers apartment unit count verification and building permit validity",
    legalBasis: [
      {
        url: "https://www.officialgazette.gov.ph/1991/10/10/republic-act-no-7160/",
        title: "Local Government Code of 1991",
  ...
  // Lending Classification Fee
  {
    ...
    description:
      "Checklist for verifying lending institution type and registration",
    notes:
      "Covers lending institution type verification and SEC registration validity",
    legalBasis: [
      {
    ...
    items: [
      ...
      {
        inspectionItemCustomId: "var-inspection-lending-registration",
        order: 2,
      },
    ],
  },
  ...
  // Pawnshop Classification Fee
  {
    ...
    items: [
      ...
      {
        inspectionItemCustomId: "var-inspection-pawnshop-registration",
        order: 2,
      },
    ],
  },
  ...
  // Parking Available (Yes/No)
  {
    ...
    items: [
      {
        inspectionItemCustomId: "var-inspection-parking-availability",
        order: 1,
      },
    ],
  },
...
async function seedVariableChecklists() {
  ...
  for (const checklistData of VARIABLE_CHECKLISTS) {
    ...
    if (!existing) {
      ...
      totalCreated++;
      console.log(
        `  + Created: ${checklistData.name} (variable: ${variableCustomId})`,
      );
      ...
      totalUpdated++;
      console.log(
        `  ~ Updated: ${checklistData.name} (variable: ${variableCustomId})`,
      );
