...
const { setupMongoDB, teardownMongoDB, setupApp, setupTestEnvironment } = require('../helpers/setup');
  ...
  describe('Public Endpoints', () => {
    describe('GET /api/public/business/stats', () => {
      it('should return public stats without auth', async () => {
        ...
        expect(response.body.data).toHaveProperty('applicationsProcessedThisYear');
      });
    });
  });
